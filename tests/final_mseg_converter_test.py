...
class CommonUnitTest(unittest.TestCase):
    ...
    flag_map_dat = {
        "res_bldg_types": ["single family home", "multi family home", "mobile home"],
        "com_bldg_types": [
            "assembly",
            "education",
            "food sales",
        ...
        "res_fuel_types": ["electricity", "natural gas", "distillate", "other fuel"],
        "com_fuel_types": ["electricity", "natural gas", "distillate"],
        "res_eus": [
            "heating",
            "secondary heating",
            "cooling",
...
class DataRestructuringFunctionTest(CommonUnitTest):
    ...
    orig_input = {
        ...
        "mercantile/service": {
            ...
            "natural gas": {"water heating": {"2009": 20, "2010": 22, "2011": 23}},
        },
    }
    ...
    loutput = [
        {
            "single family home": {
                "new homes": {"2009": 117.6489, "2010": 117.6489, "2011": 117.6489},
                "total homes": {"2009": 235.2978, "2010": 235.2978, "2011": 235.2978},
                "square footage": {"2009": 352.9467, "2010": 352.9467, "2011": 352.9467},
                "electricity": {
                    "lighting": {
                        "linear fluorescent": {
                            "energy": {"2009": 16.9584, "2010": 18.0183, "2011": 19.0782},
                            "stock": {"2009": 13.7787, "2010": 14.8386, "2011": 15.8985},
                        }
                    }
                },
            },
            "mercantile/service": {
                "total square footage": {"2009": 21.9374, "2010": 24.2466, "2011": 23.092},
                "new square footage": {"2009": 6.9276, "2010": 5.773, "2011": 4.6184},
                "electricity": {
                    "lighting": {
                        "F96T8 HO_HB": {
                            "stock": {"2009": 0.3464, "2010": 0.6928, "2011": 0.8082},
                            "energy": {"2009": 0.3464, "2010": 0.6928, "2011": 0.8082},
                        }
                    }
                },
                "natural gas": {"water heating": {"2009": 23.092, "2010": 25.401, "2011": 26.556}},
            },
        },
        {
            "single family home": {
                "new homes": {"2009": 128.2494, "2010": 128.2494, "2011": 128.2494},
                "total homes": {"2009": 256.4988, "2010": 256.4988, "2011": 256.4988},
                "square footage": {"2009": 384.7482, "2010": 384.7482, "2011": 384.7482},
                "electricity": {
                    "lighting": {
                        "linear fluorescent": {
                            "energy": {"2009": 18.4864, "2010": 19.6418, "2011": 20.7972},
                            "stock": {"2009": 15.0202, "2010": 16.1756, "2011": 17.331},
                        }
                    }
                },
            },
            "mercantile/service": {
                "natural gas": {
                    "water heating": {"2009": 25.336, "2010": 27.8696, "2011": 29.1363}
                },
                "total square footage": {"2009": 24.0692, "2010": 26.6028, "2011": 25.336},
                "new square footage": {"2009": 7.6008, "2010": 6.334, "2011": 5.0672},
                "electricity": {
                    "lighting": {
                        "F96T8 HO_HB": {
                            "stock": {"2009": 0.38, "2010": 0.7601, "2011": 0.8866},
                            "energy": {"2009": 0.38, "2010": 0.7601, "2011": 0.8866},
                        }
                    }
                },
            },
...
class ComStockGapBlendingTest(CommonUnitTest):
    ...
    # electricity CSVs
    com_cd_cz_array_emm = np.array(
        [(1, 0.2389, 0.7611, 0.0, 0.0, 0.0), (2, 0.1546, 0.3568, 0.4886, 0.0, 0.0)],
        dtype=[
            ("CDIV", "<i4"),
            ("TRE", "<f8"),
            ("FRCC", "<f8"),
    ...
    com_cd_cz_array_gap_emm = np.array(
        [(1, 0.9, 0.1, 0.0, 0.0, 0.0), (2, 0.2, 0.3, 0.5, 0.0, 0.0)],
        dtype=[
            ("CDIV", "<i4"),
            ("TRE", "<f8"),
            ("FRCC", "<f8"),
    ...
    com_cd_cz_array_fuelsplit_gap = {
        "electricity": {
            "stock": {"water heating": com_cd_cz_array_emm, "gap": com_cd_cz_array_gap_emm},
            "energy": {"water heating": com_cd_cz_array_emm, "gap": com_cd_cz_array_gap_emm},
        },
    ...
    def _make_input(self, bldg_type):
        return {
            bldg_type: {
                "electricity": {"water heating": {"stock": {"2009": 100}, "energy": {"2009": 200}}}
            }
        }
    ...
    def test_non_electric_fuel_never_blended(self):
        ...
        base_input = {
            "assembly": {
                "natural gas": {"water heating": {"stock": {"2009": 100}, "energy": {"2009": 200}}}
            }
        }
        add_input = copy.deepcopy(base_input)
        result = fmc.merge_sum(
    ...
    com_cd_cz_array_tech_emm = np.array(
        [(1, "rooftop_AC", 0.3, 0.7, 0.0, 0.0, 0.0), (2, "rooftop_AC", 0.4, 0.2, 0.4, 0.0, 0.0)],
        dtype=[
            ("CDIV", "<i4"),
            ("Technology", "U20"),
            ("TRE", "<f8"),
    ...
    com_cd_cz_array_gap_tech_emm = np.array(
        [(1, "all", 0.9, 0.1, 0.0, 0.0, 0.0), (2, "all", 0.2, 0.3, 0.5, 0.0, 0.0)],
        dtype=[
            ("CDIV", "<i4"),
            ("Technology", "U20"),
            ("TRE", "<f8"),
    ...
    com_cd_cz_array_fuelsplit_tech_gap = {
        "electricity": {
            "stock": {"cooling": com_cd_cz_array_tech_emm, "gap": com_cd_cz_array_gap_tech_emm},
            "energy": {"cooling": com_cd_cz_array_tech_emm, "gap": com_cd_cz_array_gap_tech_emm},
        }
    }
    ...
    def test_partial_gap_technology_level(self):
        ...
        base_input = {
            "food service": {
                "electricity": {
                    "cooling": {
                        "supply": {"rooftop_AC": {"stock": {"2009": 100}, "energy": {"2009": 200}}}
                    }
                }
            }
        }
        ...
        nongap_fact = float(
            self.com_cd_cz_array_tech_emm[
                self.com_cd_cz_array_tech_emm["Technology"] == "rooftop_AC"
            ][0]["TRE"]
        )
        gap_fact = float(
            self.com_cd_cz_array_gap_tech_emm[
                self.com_cd_cz_array_gap_tech_emm["Technology"] == "all"
            ][0]["TRE"]
        )
        blended = 0.5 * gap_fact + 0.5 * nongap_fact
        expected = {
...
class ToClimateZoneConversionTest(CommonUnitTest):
    ...
    test_energy_stock_input = {
        "new england": {
            "single family home": {
                "new homes": {"2009": 1, "2010": 11, "2011": 1},
                "total homes": {"2009": 2, "2010": 22, "2011": 2},
                "square footage": {"2009": 3, "2010": 33, "2011": 3},
                "electricity": {
                    "lighting": {
                        "linear fluorescent": {
                            "stock": {"2009": 1, "2010": 2, "2011": 3},
                            "energy": {"2009": 4, "2010": 5, "2011": 6},
                        }
                    },
                    "heating": {
                        "demand": {
                            "wall": {"stock": "NA", "energy": {"2009": 3.5, "2010": 4, "2011": 5}}
                        }
                    },
                },
            },
            "mercantile/service": {
                "total square footage": {"2009": 12, "2010": 13, "2011": 14},
                "new square footage": {"2009": 2, "2010": 3, "2011": 4},
                "electricity": {
                    "lighting": {
                        "F96T8 HO_HB": {
                            "stock": {"2009": 0.1, "2010": 0.2, "2011": 0.3},
                            "energy": {"2009": 0.1, "2010": 0.2, "2011": 0.3},
                        }
                    }
                },
                "natural gas": {"water heating": {"2009": 5, "2010": 6, "2011": 7}},
            },
        },
        "mid atlantic": {
            "single family home": {
                "new homes": {"2009": 11, "2010": 11, "2011": 11},
                "total homes": {"2009": 22, "2010": 22, "2011": 22},
                "square footage": {"2009": 33, "2010": 33, "2011": 33},
                "electricity": {
                    "lighting": {
                        "linear fluorescent": {
                            "stock": {"2009": 7, "2010": 8, "2011": 9},
                            "energy": {"2009": 10, "2010": 11, "2011": 12},
                        }
                    },
                    "heating": {
                        "demand": {
                            "wall": {"stock": "NA", "energy": {"2009": 6, "2010": 7, "2011": 8}}
                        }
                    },
                },
            },
            "mercantile/service": {
                "total square footage": {"2009": 6, "2010": 7, "2011": 8},
                "new square footage": {"2009": 2, "2010": 0, "2011": 1},
                "electricity": {
                    "lighting": {
                        "F96T8 HO_HB": {
                            "stock": {"2009": 0.5, "2010": 0.6, "2011": 0.7},
                            "energy": {"2009": 0.5, "2010": 0.6, "2011": 0.7},
                        }
                    }
                },
                "natural gas": {"water heating": {"2009": 10, "2010": 11, "2011": 9}},
            },
        },
        "east north central": {
            "single family home": {
                ...
                "electricity": {
                    ...
                    "heating": {
                        "demand": {
                            "wall": {"stock": "NA", "energy": {"2009": 2, "2010": 3, "2011": 4}}
                        }
                    },
                },
            },
                ...
                "distillate": {
                    "heating": {
                        "supply": {
                            "boiler (distillate)": {
                                "installed cost": {
                                    "typical": {"2015": 20, "2016": 30, "2017": 40},
                                    "best": {"2015": 20, "2016": 30, "2017": 40},
                                    "source": "EIA AEO",
                                    "units": "2013$/kBTU out/hr",
                                },
                                "performance": {
                                    "typical": {"2015": 5, "2016": 6, "2017": 7},
                                    "best": {"2015": 5, "2016": 6, "2017": 7},
                                    "source": "EIA AEO",
                                    "units": "BTU out/BTU in",
                                },
                                "lifetime": {
                                    "average": {"2015": 25, "2016": 25, "2017": 25},
                                    "range": {"2015": 25, "2016": 25, "2017": 25},
                                    "source": "EIA AEO",
                                    "units": "years",
                                },
                            }
            ...
            "assembly": {
                ...
                "electricity": {
                    "refrigeration": {
                        ...
                        "Supermkt_display_case": {
                            "installed cost": {
                                "typical": {"2015": 3.5, "2016": 4.5, "2017": 5.5},
                                "best": {"2015": 4.5, "2016": 5.5, "2017": 6.5},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                                "typical": {"2015": 15, "2016": 15, "2017": 18},
                                "best": {"2015": 15, "2016": 15, "2017": 20},
                                "source": "EIA AEO",
                                "units": "BTU out/BTU in",
                            },
                            "lifetime": {
                                "average": {"2015": 16, "2016": 16, "2017": 16},
                                "range": {"2015": 24, "2016": 24, "2017": 24},
                                "source": "EIA AEO",
                                "units": "years",
                            },
                        },
                ...
                "natural gas": {
                    "water heating": {
                        ...
                        "gas_water_heater": {
                            "installed cost": {
                                "typical": {"2015": 6, "2016": 6, "2017": 6},
                                "best": {"2015": 8, "2016": 8, "2017": 8},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                            ...
                            "lifetime": {
                                "average": {"2015": 20, "2016": 20, "2017": 20},
                                "range": {"2015": 30, "2016": 30, "2017": 30},
                                "source": "EIA AEO",
                                "units": "years",
                            },
                        },
                ...
                "distillate": {
                    "heating": {
                        "supply": {
                            "boiler (distillate)": {
                                "installed cost": {
                                    "typical": {"2015": 7, "2016": 8, "2017": 9},
                                    "best": {"2015": 10, "2016": 12, "2017": 14},
                                    "source": "EIA AEO",
                                    "units": "2013$/kBTU out/hr",
                                },
                                "performance": {
            ...
            "assembly": {
                ...
                "electricity": {
                    "refrigeration": {
                        ...
                        "Supermkt_display_case": {
                            "installed cost": {
                                "typical": {"2015": 28, "2016": 35, "2017": 57},
                                "best": {"2015": 36, "2016": 50, "2017": 53.3},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                                "typical": {"2015": 15, "2016": 18, "2017": 21},
                                "best": {"2015": 16, "2016": 19, "2017": 22},
                                "source": "EIA AEO",
                                "units": "BTU out/BTU in",
                            },
                            "lifetime": {
                                "average": {"2015": 19, "2016": 19, "2017": 19},
                                "range": {"2015": 28, "2016": 28, "2017": 28},
                                "source": "EIA AEO",
                                "units": "years",
                            },
                        },
                ...
                "natural gas": {
                    "water heating": {
                        ...
                        "gas_water_heater": {
                            "installed cost": {
                                "typical": {"2015": 10, "2016": 15, "2017": 20},
                                "best": {"2015": 10, "2016": 15, "2017": 20},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                                "typical": {"2015": 4, "2016": 5, "2017": 6},
                                "best": {"2015": 4, "2016": 5, "2017": 6},
                                "source": "EIA AEO",
                                "units": "BTU out/BTU in",
                            },
                            "lifetime": {
                                "average": {"2015": 7, "2016": 8, "2017": 9},
                                "range": {"2015": 10, "2016": 11, "2017": 12},
                                "source": "EIA AEO",
                                "units": "years",
                            },
                        },
            ...
            "assembly": {
                ...
                "electricity": {
                    "refrigeration": {
                        ...
                        "Supermkt_display_case": {
                            "installed cost": {
                                "typical": {"2015": 11, "2016": 12, "2017": 14},
                                "best": {"2015": 16, "2016": 18, "2017": 20},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                                "typical": {"2015": 23, "2016": 23, "2017": 23},
                                "best": {"2015": 27, "2016": 27, "2017": 27},
                                "source": "EIA AEO",
                                "units": "BTU out/BTU in",
                            },
                            "lifetime": {
                ...
                "natural gas": {
                    "water heating": {
                        ...
                        "gas_water_heater": {
                            "installed cost": {
                                "typical": {"2015": 3, "2016": 5, "2017": 7},
                                "best": {"2015": 4, "2016": 6, "2017": 8},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                                "typical": {"2015": 1.5, "2016": 2.5, "2017": 3.5},
                                "best": {"2015": 2.5, "2016": 3.5, "2017": 4.5},
                                "source": "EIA AEO",
                                "units": "BTU out/BTU in",
                            },
                            "lifetime": {
                                "average": {"2015": 6, "2016": 6, "2017": 6},
                                "range": {"2015": 6, "2016": 6, "2017": 6},
                                "source": "EIA AEO",
                                "units": "years",
                            },
                        },
    ...
    test_energy_stock_output = {
        "AIA_CZ1": {
            "single family home": {
                "new homes": {"2009": 18.1279, "2010": 20.3239, "2011": 18.1279},
                "total homes": {"2009": 36.2558, "2010": 40.6478, "2011": 36.2558},
                "square footage": {"2009": 54.3837, "2010": 60.9717, "2011": 54.3837},
                "electricity": {
                    "lighting": {
                        "linear fluorescent": {
                            "stock": {"2009": 2.6591, "2010": 3.0940, "2011": 3.5289},
                            "energy": {"2009": 3.9638, "2010": 4.3987, "2011": 4.8336},
                        }
                    },
                    "heating": {
                        "demand": {
                            "wall": {
                                "stock": "NA",
                                "energy": {"2009": 1.4388, "2010": 1.7639, "2011": 2.1988},
                            }
                        }
                    },
                },
            ...
            "mercantile/service": {
                "total square footage": {"2009": 8.8636, "2010": 9.7907, "2011": 9.9174},
                "new square footage": {"2009": 2.3878, "2010": 2.0507, "2011": 2.1774},
                "electricity": {
                    "lighting": {
                        "F96T8 HO_HB": {
                            "stock": {"2009": 0.1812, "2010": 0.3006, "2011": 0.3667},
                            "energy": {"2009": 0.1812, "2010": 0.3006, "2011": 0.3667},
                        }
                    }
                },
                "natural gas": {"water heating": {"2009": 8.0765, "2010": 9.0036, "2011": 9.2001}},
            },
        },
        "AIA_CZ2": {
            "single family home": {
                "new homes": {"2009": 79.2779, "2010": 86.5509, "2011": 79.2779},
                "total homes": {"2009": 158.5558, "2010": 173.1018, "2011": 158.5558},
                "square footage": {"2009": 237.8337, "2010": 259.6527, "2011": 237.8337},
                "electricity": {
                    "lighting": {
                        "linear fluorescent": {
                            "stock": {"2009": 11.8729, "2010": 13.6148, "2011": 15.3567},
                            "energy": {"2009": 17.0986, "2010": 18.8405, "2011": 20.5824},
                        }
                    },
                    "heating": {
                        "demand": {
                            "wall": {
                                "stock": "NA",
                                "energy": {"2009": 5.9376, "2010": 7.3158, "2011": 9.0578},
                            }
                        }
                    },
                },
            ...
            "mercantile/service": {
                "total square footage": {"2009": 25.2048, "2010": 27.7891, "2011": 28.1738},
                "new square footage": {"2009": 6.635, "2010": 5.9493, "2011": 6.334},
                "electricity": {
                    "lighting": {
                        "F96T8 HO_HB": {
                            "stock": {"2009": 0.4745, "2010": 0.8062, "2011": 0.9913},
                            "energy": {"2009": 0.4745, "2010": 0.8062, "2011": 0.9913},
                        }
                    }
                },
                "natural gas": {
                    "water heating": {"2009": 22.0375, "2010": 24.6218, "2011": 25.4025}
                },
            },
        },
        "AIA_CZ3": {
            "single family home": {
                "new homes": {"2009": 25.5943, "2010": 26.1263, "2011": 25.5943},
                "total homes": {"2009": 51.1886, "2010": 52.2526, "2011": 51.1886},
                "square footage": {"2009": 76.7829, "2010": 78.3789, "2011": 76.7829},
                "electricity": {
                    "lighting": {
                        "linear fluorescent": {
                            "stock": {"2009": 6.4681, "2010": 7.2914, "2011": 8.1147},
                            "energy": {"2009": 8.9380, "2010": 9.7613, "2011": 10.5846},
                        }
                    },
                    "heating": {
                        "demand": {
                            "wall": {
                                "stock": "NA",
                                "energy": {"2009": 4.124, "2010": 4.9207, "2011": 5.744},
                            }
                        }
                    },
                },
            ...
            "mercantile/service": {
                "total square footage": {"2009": 2.9316, "2010": 3.4202, "2011": 3.9088},
                "new square footage": {"2009": 0.9772, "2010": 0, "2011": 0.4886},
                "electricity": {
                    "lighting": {
                        "F96T8 HO_HB": {
                            "stock": {"2009": 0.2443, "2010": 0.2932, "2011": 0.3420},
                            "energy": {"2009": 0.2443, "2010": 0.2932, "2011": 0.3420},
                        }
                    }
                },
                "natural gas": {"water heating": {"2009": 4.886, "2010": 5.3746, "2011": 4.3974}},
            },
        },
        "AIA_CZ4": {
            "single family home": {
                "new homes": {"2009": 0, "2010": 0, "2011": 0},
                "total homes": {"2009": 0, "2010": 0, "2011": 0},
                "square footage": {"2009": 0, "2010": 0, "2011": 0},
                "electricity": {
                    "lighting": {
                        "linear fluorescent": {
                    ...
                    "heating": {
                        "demand": {
                            "wall": {"stock": "NA", "energy": {"2009": 0, "2010": 0, "2011": 0}}
                        }
                    },
                },
            },
            "mercantile/service": {
                "total square footage": {"2009": 0, "2010": 0, "2011": 0},
                "new square footage": {"2009": 0, "2010": 0, "2011": 0},
                "electricity": {
                    "lighting": {
                        "F96T8 HO_HB": {
                            "stock": {"2009": 0, "2010": 0, "2011": 0},
                ...
                "natural gas": {"water heating": {"2009": 0, "2010": 0, "2011": 0}},
            },
        },
        "AIA_CZ5": {
            "single family home": {
                ...
                "distillate": {
                    "heating": {
                        "supply": {
                            "boiler (distillate)": {
                                "installed cost": {
                                    "typical": {"2015": 0, "2016": 0, "2017": 0},
                                    "best": {"2015": 0, "2016": 0, "2017": 0},
                                    "source": "EIA AEO",
                                    "units": "2013$/kBTU out/hr",
                                },
                                "performance": {
                                ...
                                "lifetime": {
                                    "average": {"2015": 0, "2016": 0, "2017": 0},
                                    "range": {"2015": 0, "2016": 0, "2017": 0},
                                    "source": "EIA AEO",
                                    "units": "years",
                                },
                            }
                ...
                "distillate": {
                    "heating": {
                        "supply": {
                            "boiler (distillate)": {
                                "installed cost": {
                                    "typical": {"2015": 0.1644, "2016": 0.2466, "2017": 0.3288},
                                    "best": {"2015": 0.1644, "2016": 0.2466, "2017": 0.3288},
                                    "source": "EIA AEO",
                                    "units": "2013$/kBTU out/hr",
                                },
                                "performance": {
                                    "typical": {"2015": 0.0411, "2016": 0.0493, "2017": 0.0575},
                                    "best": {"2015": 0.0411, "2016": 0.0493, "2017": 0.0575},
                                    "source": "EIA AEO",
                                    "units": "BTU out/BTU in",
                                },
                                "lifetime": {
                                    "average": {"2015": 0.2055, "2016": 0.2055, "2017": 0.2055},
                                    "range": {"2015": 0.2055, "2016": 0.2055, "2017": 0.2055},
                                    "source": "EIA AEO",
                                    "units": "years",
                                },
                            }
                ...
                "distillate": {
                    "heating": {
                        "supply": {
                            "boiler (distillate)": {
                                "installed cost": {
                                    "typical": {"2015": 4.4371, "2016": 6.4828, "2017": 8.5284},
                                    "best": {"2015": 4.7241, "2016": 6.8389, "2017": 8.9537},
                                    "source": "EIA AEO",
                                    "units": "2013$/kBTU out/hr",
                                },
                                "performance": {
                                    "typical": {"2015": 1.5121, "2016": 1.8023, "2017": 2.0934},
                                    "best": {"2015": 1.7991, "2016": 2.1589, "2017": 2.5187},
                                    "source": "EIA AEO",
                                    "units": "BTU out/BTU in",
                                },
                                "lifetime": {
                                    "average": {"2015": 7.2665, "2016": 7.2665, "2017": 7.2665},
                                    "range": {"2015": 7.2665, "2016": 7.2665, "2017": 7.2665},
                                    "source": "EIA AEO",
                                    "units": "years",
                                },
                            }
            ...
            "assembly": {
                ...
                "electricity": {
                    "refrigeration": {
                        ...
                        "Supermkt_display_case": {
                            "installed cost": {
                                "typical": {"2015": 4.1228, "2016": 5.1064, "2017": 7.6262},
                                "best": {"2015": 5.3831, "2016": 7.1072, "2017": 7.767},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                                "typical": {"2015": 6.1551, "2016": 6.4535, "2017": 7.4807},
                                "best": {"2015": 6.4318, "2016": 6.7303, "2017": 8.2433},
                                "source": "EIA AEO",
                                "units": "BTU out/BTU in",
                            },
                            "lifetime": {
                                "average": {"2015": 6.087, "2016": 6.1313, "2017": 6.1756},
                                "range": {"2015": 9.0586, "2016": 9.1029, "2017": 9.1472},
                                "source": "EIA AEO",
                                "units": "years",
                            },
                        },
                ...
                "natural gas": {
                    "water heating": {
                        ...
                        "gas_water_heater": {
                            "installed cost": {
                                "typical": {"2015": 2.5852, "2016": 3.1712, "2017": 3.7572},
                                "best": {"2015": 3.1154, "2016": 3.7014, "2017": 4.2873},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                                "typical": {"2015": 1.3146, "2016": 1.7013, "2017": 2.088},
                                "best": {"2015": 1.6018, "2016": 1.9886, "2017": 2.3753},
                                "source": "EIA AEO",
                                "units": "BTU out/BTU in",
                            },
                            "lifetime": {
                                "average": {"2015": 5.8208, "2016": 5.9202, "2017": 6.0197},
                                "range": {"2015": 8.5485, "2016": 8.6479, "2017": 8.7474},
                                "source": "EIA AEO",
                                "units": "years",
                            },
                        },
                ...
                "distillate": {
                    "heating": {
                        "supply": {
                            "boiler (distillate)": {
                                "installed cost": {
                                    "typical": {"2015": 7.2484, "2016": 10.5619, "2017": 13.8756},
                                    "best": {"2015": 7.8376, "2016": 11.2754, "2017": 14.7132},
                                    "source": "EIA AEO",
                                    "units": "2013$/kBTU out/hr",
                                },
                                "performance": {
                                    "typical": {"2015": 2.5726, "2016": 3.0807, "2017": 3.5888},
                                    "best": {"2015": 3.1618, "2016": 3.7941, "2017": 4.4265},
                                    "source": "EIA AEO",
                                    "units": "BTU out/BTU in",
                                },
                                "lifetime": {
                                    "average": {"2015": 12.703, "2016": 12.703, "2017": 12.703},
                                    "range": {"2015": 12.703, "2016": 12.703, "2017": 12.703},
                                    "source": "EIA AEO",
                                    "units": "years",
                                },
                            }
            ...
            "assembly": {
                ...
                "electricity": {
                    "refrigeration": {
                        ...
                        "Supermkt_display_case": {
                            "installed cost": {
                                "typical": {"2015": 6.3293, "2016": 7.7362, "2017": 11.1451},
                                "best": {"2015": 8.3775, "2016": 10.7875, "2017": 11.8615},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                                "typical": {"2015": 10.8988, "2016": 11.2734, "2017": 12.8594},
                                "best": {"2015": 11.54, "2016": 11.9146, "2017": 14.3082},
                                "source": "EIA AEO",
                                "units": "BTU out/BTU in",
                            },
                            "lifetime": {
                                "average": {"2015": 9.7366, "2016": 9.8657, "2017": 9.9948},
                                "range": {"2015": 14.4779, "2016": 14.607, "2017": 14.7361},
                                "source": "EIA AEO",
                                "units": "years",
                            },
                        },
                ...
                "natural gas": {
                    "water heating": {
                        ...
                        "gas_water_heater": {
                            "installed cost": {
                                "typical": {"2015": 4.0586, "2016": 4.9411, "2017": 5.8236},
                                "best": {"2015": 4.9953, "2016": 5.8778, "2017": 6.7602},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                                "typical": {"2015": 2.1063, "2016": 2.7641, "2017": 3.4218},
                                "best": {"2015": 2.6392, "2016": 3.297, "2017": 3.9547},
                                "source": "EIA AEO",
                                "units": "BTU out/BTU in",
                            },
                            "lifetime": {
                                "average": {"2015": 9.7244, "2016": 9.8492, "2017": 9.9741},
                                "range": {"2015": 14.1368, "2016": 14.2617, "2017": 14.3866},
                                "source": "EIA AEO",
                                "units": "years",
                            },
                        },
                ...
                "distillate": {
                    "heating": {
                        "supply": {
                            "boiler (distillate)": {
                                "installed cost": {
                                    "typical": {"2015": 8.414, "2016": 12.4205, "2017": 16.4269},
                                    "best": {"2015": 9.9189, "2016": 14.0056, "2017": 18.0923},
                                    "source": "EIA AEO",
                                    "units": "2013$/kBTU out/hr",
                                },
                                "performance": {
                                    "typical": {"2015": 3.1568, "2016": 4.0089, "2017": 4.8611},
                                    "best": {"2015": 4.6618, "2016": 5.5941, "2017": 6.5265},
                                    "source": "EIA AEO",
                                    "units": "BTU out/BTU in",
                                },
                                "lifetime": {
                                    "average": {"2015": 21.3033, "2016": 21.3033, "2017": 21.3033},
                                    "range": {"2015": 21.3033, "2016": 21.3033, "2017": 21.3033},
                                    "source": "EIA AEO",
                                    "units": "years",
                                },
                            }
            ...
            "assembly": {
                ...
                "electricity": {
                    "refrigeration": {
                        ...
                        "Supermkt_display_case": {
                            "installed cost": {
                                "typical": {"2015": 8.3794, "2016": 9.5692, "2017": 11.9311},
                                "best": {"2015": 11.7809, "2016": 13.807, "2017": 15.3838},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                                "typical": {"2015": 18.4077, "2016": 18.5337, "2017": 19.72},
                                "best": {"2015": 20.6195, "2016": 20.7454, "2017": 22.6386},
                                "source": "EIA AEO",
                                "units": "BTU out/BTU in",
                            },
                            "lifetime": {
                                "average": {"2015": 10.2501, "2016": 10.7925, "2017": 11.3349},
                                "range": {"2015": 15.0829, "2016": 15.6253, "2017": 16.1678},
                                "source": "EIA AEO",
                                "units": "years",
                            },
                        },
                ...
                "natural gas": {
                    "water heating": {
                        ...
                        "gas_water_heater": {
                            "installed cost": {
                                "typical": {"2015": 4.1679, "2016": 5.4627, "2017": 6.7574},
                                "best": {"2015": 5.4172, "2016": 6.712, "2017": 8.0068},
                                "source": "EIA AEO",
                                "units": "2013$/kBTU out/hr",
                            },
                            "performance": {
                                "typical": {"2015": 2.2187, "2016": 3.1566, "2017": 4.0945},
                                "best": {"2015": 3.1146, "2016": 4.0525, "2017": 4.9904},
                                "source": "EIA AEO",
                                "units": "BTU out/BTU in",
                            },
                            "lifetime": {
                                "average": {"2015": 10.6177, "2016": 10.6597, "2017": 10.7017},
                                "range": {"2015": 14.2782, "2016": 14.3202, "2017": 14.3622},
                                "source": "EIA AEO",
                                "units": "years",
                            },
                        },
    ...
    def test_conversion_of_energy_stock_square_footage_data(self):
        dict1 = fmc.clim_converter(
            self.test_energy_stock_input,
            self.res_cd_cz_array,
            self.com_cd_cz_array,
...
class EnvelopeDataUnitTest(CommonUnitTest):
    ...
    envelope_cpl_data = {
        "envelope": {
            "windows": {
                "residential": {
                    "cost": {"typical": 48.40, "units": "2016$/ft^2 glazing", "source": "Source A"},
                    "performance": {
                        "conduction": {
                            "typical": {
                                "AIA_CZ1": 3.13,
                ...
                "commercial": {
                    "cost": {"typical": 56.20, "units": "2016$/ft^2 glazing", "source": "Source C"},
                    "performance": {
                        "conduction": {
                            "typical": {
                                "AIA_CZ1": 2.86,
            ...
            "infiltration": {
                "residential": {
                    "cost": {"typical": 0, "units": "2016$/ft^2 wall", "source": "NA"},
                    "performance": {
                        "typical": {
                            "new": {
                                "AIA_CZ1": 3,
            ...
            "ground": {
                "residential": {
                    "cost": {
                        "typical": {"new": 5.03, "existing": 8.48},
                ...
                "commercial": {
                    "cost": {
                        "typical": {"new": 5.03, "existing": 12.23},
                        "units": "2016$/ft^2 footprint",
                        "source": "Source J",
                    },
                    "performance": {
    ...
    cost_convert_data = {
        "building type conversions": {
            ...
            "conversion data": {
                ...
                "notes": {"residential": "Explanatory text.", "commercial": "Explanatory text."},
            },
        },
                        ...
                        "conversion factor": {
                            ...
                            "value": {
                                ...
                                "commercial": {
                                    ...
                                    "large office": {"LargeOffice": 0.38, "MediumOffice": 0.33},
                                    "small office": {
                                        "SmallOffice": 0.21,
                            ...
                            "units": None,
                            "source": {"residential": "Source G", "commercial": "Source J"},
                            "notes": "Explanatory text.",
                        },
                    },
                    "walls": {
                        ...
                        "conversion factor": {
                            ...
                            "value": {
                                ...
                                "commercial": {
                                    ...
                                    "large office": {"LargeOffice": 0.26, "MediumOffice": 0.40},
                                    "small office": {
                                        "SmallOffice": 0.55,
                            ...
                            "units": None,
                            "source": {"residential": "Source H", "commercial": "Source F"},
                            "notes": "Explanatory text.",
                        },
                    },
                    "footprint": {
                        ...
                        "conversion factor": {
                            ...
                            "value": {
                                ...
                                "commercial": {
                                    ...
                                    "large office": {"LargeOffice": 0.083, "MediumOffice": 0.33},
                                    "small office": {
                                        "SmallOffice": 1,
                            ...
                            "units": None,
                            "source": {"residential": "Source G", "commercial": "Source F"},
                            "notes": "Explanatory text.",
                        },
                    },
                    "roof": {
...
class EnvelopeDataHandlerFunctionTest(EnvelopeDataUnitTest):
    ...
    sample_keys_aia = [
        ["AIA_CZ2", "warehouse", "natural gas", "heating", "demand", "windows solar"],
        ["AIA_CZ3", "health care", "electricity", "cooling", "demand", "people gain"],
        ["AIA_CZ4", "single family home", "electricity", "heating", "demand", "windows conduction"],
        ["AIA_CZ5", "mobile home", "electricity", "cooling", "demand", "infiltration"],
        ["AIA_CZ1", "large office", "electricity", "cooling", "demand", "ground"],
    ]
    # Test key lists (microsegment and envelope component type
    ...
    sample_keys_alt = [
        ["FRCC", "warehouse", "natural gas", "heating", "demand", "windows solar"],
        ["MISE", "health care", "electricity", "cooling", "demand", "people gain"],
        ["NWPP", "single family home", "electricity", "heating", "demand", "windows conduction"],
        ["ISNE", "mobile home", "electricity", "cooling", "demand", "infiltration"],
        ["TRE", "large office", "electricity", "cooling", "demand", "ground"],
    ]
    ...
    def test_complete_envelope_cost_performance_lifetime_output(self):
        for idx, keys in enumerate(self.sample_keys_aia):
            output = fmc.env_cpl_data_handler(
                self.envelope_cpl_data,
        ...
        "MELs": {
                ...
                "TVs": {
                    "TV": {
                        "performance": {
                            ...
                            "units": ["W", "fraction annual operating hours"],
                            "source": "Source X",
                        },
                        "cost": {
                            "typical": {"2009": 432.0, "2010": 432.0, "2011": 432.0},
                            "units": "2018$/unit",
                            "source": "Source Y",
                        },
                        "lifetime": {
                    ...
                    "home theater and audio": {
                        "performance": {
                            "typical": {
                                "active": {"2009": 72, "2010": 72, "2011": 72},
                                "sleep": {"2009": 15, "2010": 15, "2011": 15},
                                "off": {"2009": 0, "2010": 0, "2011": 0},
                            },
                            "units": "kWh/yr",
                            "source": "Source AA",
                        },
            ...
            "commercial": {
                "PCs": {
                    "performance": {
                        "typical": {
                            "active": {"2009": 183.0, "2010": 166.0, "2011": 146.0},
                            "ready": {"2009": 2.0, "2010": 2.0, "2011": 2.0},
                            "off": {"2009": 5.0, "2010": 5.0, "2011": 5.0},
                        },
                        "units": "kWh/yr",
                        "source": "Source D",
                    },
                    "cost": {
                        "typical": {"2009": 594.0, "2010": 595.0, "2011": 597.0},
                        "units": "2018$/unit",
                        "source": "Source E",
                    },
                    "lifetime": {
                ...
                "MELs": {
                    "escalators": {
                        "performance": {
                            "typical": {
                                "active": {"2009": 6904.0, "2010": 7080.0, "2011": 7247.0},
                                "off": {"2009": 6903.9, "2010": 7079.8, "2011": 7247.2},
                            },
                            "units": "kWh/yr",
                            "source": "Source Z",
                        },
...
class MELsDataHandlerFunctionTest(MELsDataUnitTest):
    ...
    sample_keys = [
        ["AIA_CZ2", "single family home", "electricity", "ceiling fan"],
        ["AIA_CZ3", "large office", "electricity", "office equipment"],
        ["AIA_CZ4", "single family home", "electricity", "TVs", "TV"],
        ["AIA_CZ5", "small office", "electricity", "MELs", "escalators"],
        ["AIA_CZ3", "assembly", "electricity", "office equipment"],
        ["AIA_CZ4", "single family home", "electricity", "TVs", "home theater and audio"],
    ...
    cpl_results = [
        {
            ...
            "lifetime": {"average": 13.8, "range": 3.5, "units": "years", "source": "Source C"},
        },
        {
            "installed cost": {
            ...
            "lifetime": {"average": 5, "range": 2, "units": "years", "source": "Source F"},
        },
        {
            "installed cost": {
            ...
            "lifetime": {"average": 8, "range": 6, "units": "years", "source": "Source Z"},
        },
        0,
        {
            "installed cost": {
        ...
        },
        {
            ...
            "lifetime": {"average": 10, "range": 10, "units": "years", "source": "Source CC"},
        },
    ...
    def test_complete_mels_cost_performance_lifetime_output(self):
        for idx, keys in enumerate(self.sample_keys):
            output = fmc.mels_cpl_data_handler(
                self.mels_cpl_data, self.conversions_data, self.the_years, keys
            )
...
class CostUnitsConversionTest(EnvelopeDataUnitTest):
    ...
    def test_units_conversion_of_envelope_cost_data(self):
        for idx, conv_inp in enumerate(self.cost_convert_input):
            exc_cost, exc_units = fmc.cost_converter(
                conv_inp[0], conv_inp[1], conv_inp[2], conv_inp[3], self.cost_convert_data
            )
            # Check the cost values
            self.assertAlmostEqual(exc_cost, self.cost_convert_output[idx][0], places=3)
