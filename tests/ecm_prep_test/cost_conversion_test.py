...
def test_data():
    ...
    handyvars.consumer_price_ind = numpy.array([
        ('2008-01-01', 211.398), ('2008-02-01', 211.398),
        ('2008-03-01', 211.398),
        ('2008-04-01', 211.398), ('2008-05-01', 211.398),
        ('2008-06-01', 211.398),
        ('2008-07-01', 211.398), ('2008-08-01', 211.398),
        ('2008-09-01', 211.398),
        ('2008-10-01', 211.398), ('2008-11-01', 211.398),
        ('2008-12-01', 211.398),
        ('2009-01-01', 217.347), ('2009-02-01', 217.347),
        ('2009-03-01', 217.347),
        ('2009-04-01', 217.347), ('2009-05-01', 217.347),
        ('2009-06-01', 217.347),
        ('2009-07-01', 217.347), ('2009-08-01', 217.347),
        ('2009-09-01', 217.347),
        ('2009-10-01', 217.347), ('2009-11-01', 217.347),
        ('2009-12-01', 217.347),
        ('2010-01-01', 220.472), ('2010-02-01', 220.472),
        ('2010-03-01', 220.472),
        ('2010-04-01', 220.472), ('2010-05-01', 220.472),
        ('2010-06-01', 220.472),
        ('2010-07-01', 220.472), ('2010-08-01', 220.472),
        ('2010-09-01', 220.472),
        ('2010-10-01', 220.472), ('2010-11-01', 220.472),
        ('2010-12-01', 220.472),
        ('2011-01-01', 227.223), ('2011-02-01', 227.223),
        ('2011-03-01', 227.223),
        ('2011-04-01', 227.223), ('2011-05-01', 227.223),
        ('2011-06-01', 227.223),
        ('2011-07-01', 227.223), ('2011-08-01', 227.223),
        ('2011-09-01', 227.223),
        ('2011-10-01', 227.223), ('2011-11-01', 227.223),
        ('2011-12-01', 227.223),
        ('2012-01-01', 231.272), ('2012-02-01', 231.272),
        ('2012-03-01', 231.272),
        ('2012-04-01', 231.272), ('2012-05-01', 231.272),
        ('2012-06-01', 231.272),
        ('2012-07-01', 231.272), ('2012-08-01', 231.272),
        ('2012-09-01', 231.272),
        ('2012-10-01', 231.272), ('2012-11-01', 231.272),
        ('2012-12-01', 231.272),
        ('2013-01-01', 234.847), ('2013-02-01', 234.847),
        ('2013-03-01', 234.847),
        ('2013-04-01', 234.847), ('2013-05-01', 234.847),
        ('2013-06-01', 234.847),
        ('2013-07-01', 234.847), ('2013-08-01', 234.847),
        ('2013-09-01', 234.847),
        ('2013-10-01', 234.847), ('2013-11-01', 234.847),
        ('2013-12-01', 234.847),
        ('2014-01-01', 236.464), ('2014-02-01', 236.464),
        ('2014-03-01', 236.464),
        ('2014-04-01', 236.464), ('2014-05-01', 236.464),
        ('2014-06-01', 236.464),
        ('2014-07-01', 236.464), ('2014-08-01', 236.464),
        ('2014-09-01', 236.464),
        ('2014-10-01', 236.464), ('2014-11-01', 236.464),
        ('2014-12-01', 236.464),
        ('2015-01-01', 238.041), ('2015-02-01', 238.041),
        ('2015-03-01', 238.041),
        ('2015-04-01', 238.041), ('2015-05-01', 238.041),
        ('2015-06-01', 238.041),
        ('2015-07-01', 238.041), ('2015-08-01', 238.041),
        ('2015-09-01', 238.041),
        ('2015-10-01', 238.041), ('2015-11-01', 238.041),
        ('2015-12-01', 238.041),
        ('2016-01-01', 239.41), ('2016-02-01', 239.41),
        ('2016-03-01', 239.41),
    ...
    cost_meas_units_ok_in_all = [
        '$/ft^2 glazing', '2013$/ft^2 floor', '2010$/ft^2 footprint',
        '2016$/ft^2 roof', '2013$/ft^2 wall', '2010$/ft^2 floor',
        '2013$/ft^2 roof', '2017$/ft^2 floor', '2010$/ft^2 floor']
    cost_meas_units_fail_in = [
        '$/ft^2 facade', '$/kWh', '$/occupant', '$/node']
    cost_base_units_fail_in = [
        '2013$/ft^2 floor', '2013$/kBtu/h heating',
        '2017$/kBtu/h cooling', '2017$/1000 lm']
    cost_base_units_ok_in = [
        '$/ft^2 floor', '2013$/kBtu/h heating', '2010$/ft^2 floor',
        '2016$/ft^2 floor', '2013$/ft^2 floor', '2012$/1000 CFM',
        '2013$/ft^2 floor', '2017$/1000 CFM', '$/unit']
    cost_meas_units_ok_out = [
        '2016$/ft^2 floor', '2013$/kBtu/h heating', '2010$/ft^2 floor',
        '2016$/ft^2 floor', '2013$/ft^2 floor', '2012$/1000 CFM',
        '2013$/ft^2 floor', '2017$/1000 CFM', '2016$/ft^2 floor']
...
def test_convertcost_ok_yronly(test_data):
    ...
    func_output = test_data["sample_measure_in"].convert_costs(
        test_data["sample_convertdata_ok_in"], test_data["sample_bldgsect_ok_in"][0],
        test_data["sample_mskeys_ok_in"][0], test_data["cost_meas_ok_in"],
        test_data["cost_meas_units_ok_in_yronly"],
        test_data["cost_base_units_ok_in"][0], test_data["verbose"])
...
def test_convertcost_ok_all(test_data):
    ...
    for k in range(0, len(test_data["sample_mskeys_ok_in"])):
        func_output = test_data["sample_measure_in"].convert_costs(
            test_data["sample_convertdata_ok_in"], test_data["sample_bldgsect_ok_in"][k],
            test_data["sample_mskeys_ok_in"][k], test_data["cost_meas_ok_in"],
            test_data["cost_meas_units_ok_in_all"][k],
            test_data["cost_base_units_ok_in"][k], test_data["verbose"])
        numpy.testing.assert_almost_equal(
