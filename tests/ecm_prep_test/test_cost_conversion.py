"""Test convert_costs function for cost unit conversions."""
...
class TestCostConversion:
    ...
    def test_data(self):
        """Setup test data for cost conversion tests."""
        # Base directory
        base_dir = os.getcwd()
    ...
    def test_convertcost_ok_yronly(self, test_data):
    ...
    def test_convertcost_ok_all(self, test_data):
    ...
    def test_convertcost_fail(self, test_data):
