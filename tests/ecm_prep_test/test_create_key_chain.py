"""Test create_keychain function for generating microsegment key chains."""
...
class TestCreateKeyChain:
    ...
    def test_data(self):
        """Setup test data for create_keychain tests."""
        # Base directory
        base_dir = os.getcwd()
    ...
    def test_primary(self, test_data):
        ...
        assert result == test_data['ok_out_primary']
    ...
    def test_secondary(self, test_data):
        ...
        assert result == test_data['ok_out_secondary']
