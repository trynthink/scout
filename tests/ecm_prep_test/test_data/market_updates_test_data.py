...
ok_tpmeas_partchk_msegout_emm = [{
            ...
            "energy": {
                "total": {
                    "baseline": {"2009": 18 * 2, "2010": 18 * 2},
                    "efficient": {"2009": 9 * 2, "2010": 9 * 2}},
                "competed": {
                    "baseline": {"2009": 18 * 2, "2010": 18 * 2},
                    "efficient": {"2009": 9 * 2, "2010": 9 * 2}}},
            "carbon": {
                "total": {
                    "baseline": {
                        "2009": 1.4589e-06 * 2, "2010": 1.2924e-06 * 2},
                    "efficient": {
                        "2009": 7.2945e-07 * 2, "2010": 6.462e-07 * 2}},
                "competed": {
                    "baseline": {
                        "2009": 1.4589e-06 * 2, "2010": 1.2924e-06 * 2},
                    "efficient": {
            ...
            "cost": {
                ...
                "energy": {
                    "total": {
                        "baseline": {
                            "2009": 787.977432 * 2, "2010": 786.758796 * 2},
                        "efficient": {
                            "2009": 393.988716 * 2, "2010": 393.379398 * 2}},
                    "competed": {
                        "baseline": {
                            "2009": 787.977432 * 2, "2010": 786.758796 * 2},
                        "efficient": {
                ...
                "carbon": {
                    "total": {
                        "baseline": {
                            "2009": 5.9814899999999995e-05 * 2,
                            "2010": 5.42808e-05 * 2},
                        "efficient": {
                            "2009": 2.9907449999999998e-05 * 2,
                            "2010": 2.71404e-05 * 2}},
                    "competed": {
                         "baseline": {
                            "2009": 5.9814899999999995e-05 * 2,
...
ok_tpmeas_fullchk_break_out = _convert_numpy_strings_to_python(ok_tpmeas_fullchk_break_out)
sample_cpl_in = _convert_numpy_strings_to_python(sample_cpl_in)
ok_tpmeas_partchk_msegout = _convert_numpy_strings_to_python(ok_tpmeas_partchk_msegout)
sample_cpl_in_state = _convert_numpy_strings_to_python(sample_cpl_in_state)
sample_cpl_in_emm = _convert_numpy_strings_to_python(sample_cpl_in_emm)
sample_mseg_in = _convert_numpy_strings_to_python(sample_mseg_in)
ok_hpmeas_rates_breakouts = _convert_numpy_strings_to_python(ok_hpmeas_rates_breakouts)
ok_partialmeas_in = _convert_numpy_strings_to_python(ok_partialmeas_in)
ok_hpmeas_rates_mkts_out = _convert_numpy_strings_to_python(ok_hpmeas_rates_mkts_out)
ok_tpmeas_fullchk_msegout = _convert_numpy_strings_to_python(ok_tpmeas_fullchk_msegout)
sample_mseg_in_emm = _convert_numpy_strings_to_python(sample_mseg_in_emm)
sample_mseg_in_state = _convert_numpy_strings_to_python(sample_mseg_in_state)
ok_tpmeas_partchk_msegout_emm = _convert_numpy_strings_to_python(ok_tpmeas_partchk_msegout_emm)
ok_tpmeas_partchk_msegout_state = _convert_numpy_strings_to_python(ok_tpmeas_partchk_msegout_state)
