...
class ResidentialDataIntegrityTest(unittest.TestCase):
    ...
    def test_order_of_columns_in_header_line(self):
        ...
        self.assertTrue(
            match, msg="Column headers in the EIA data file" + "are different than expected"
        )
...
class JSONTranslatorTest(unittest.TestCase):
    ...
    ok_filters = [
        ["pacific", "multi family home", "natural gas", "heating", "demand", "ground"],
        ["new england", "mobile home", "electricity", "cooling", "demand", "people gain"],
        ["mid atlantic", "single family home", "electricity", "cooling", "supply", "room AC"],
        ["west south central", "mobile home", "electricity", "TVs", "set top box"],
        ["east north central", "mobile home", "electricity", "lighting", "general service (LED)"],
        ["west north central", "mobile home", "other fuel", "heating", "supply", "resistance"],
        [
            "south atlantic",
            "multi family home",
            "distillate",
        ...
        ["new england", "single family home", "natural gas", "water heating"],
        ...
        ["west south central", "mobile home", "electricity", "TVs", "TV"],
    ]
    ...
    nonsense_filters = [
        ["west north central", "mobile home", "natural gas", "lighting", "room AC"],
        [
            "new england",
            "single family home",
            "electricity (on site)",
    ...
    fail_filters = [
        ...
        ["pacific", "multi family home", "electricity", "computers", "video game consoles"],
        ["the moon", "mobile home", "distillate", "heating", "supply", "boiler (distillate)"],
        ["mountain", "multi family home", "natural gas", "resistance"],
        ["mid atlantic", "mobile home", "distillate", "TVs", "monitors"],
        ["mid atlantic", "mobile home", "electricity", "TVs", "antennas"],
        ["west north central", "mobile home", "electricity", "cooling", "supply", "windows solar"],
        ["west north central", "mobile home", "heating", "electricity", "demand", "room AC"],
        ["mountain", "mobile home", "sq ft"],
        ["west north central", "mobile home", "total square footage", "water heating", "room AC"],
        [
            "new england",
            "single family home",
            "other fuel",
        ...
        ["west north central", "mobile home", "new homes", "water heating", "room AC"],
        ["west north central", "mobile home", "total homes", "water heating", "room AC"],
    ]
    ...
    ok_out = [
        ...
        [["STB", 7, 3, "EL"], ""],
        [["LT", 3, 3, "EL", ("GSL", "LED")], ""],
        [["HT", 4, 3, ("LG", "KS", "CL", "GE", "WD"), "GE2"], ""],
        [["SH", 5, 2, "DS"], "WIND_SOL"],
        [["SH", 1, 1, ("LG", "KS", "CL", "GE", "WD"), "CL"], ""],
        [["HW", 1, 1, "GS"], ""],
        [["SQ", 1, 1], ""],
        [["SH", 1, 1, ("LG", "KS", "CL", "GE", "WD")], "WIND_COND"],
        [["HS", 1, 1], ""],
        [["HT", 1, 1, "EL", "ELEC_RAD"], ""],
        [["TVS", 7, 3, "EL"], ""],
    ]
    ...
    def test_ok_filters(self):
        for idx, afilter in enumerate(self.ok_filters):
            self.assertEqual(rm.json_translator(rm.res_dictlist, afilter), self.ok_out[idx])
    ...
    def test_nonsense_filters(self):
        for idx, afilter in enumerate(self.nonsense_filters):
            self.assertEqual(rm.json_translator(rm.res_dictlist, afilter), self.nonsense_out[idx])
...
class NumpyArrayReductionTest(unittest.TestCase):
    ...
    EIA_nrg_stock_out = [
        ...
        ({"2010": 3, "2011": 2, "2012": 1}, {"2010": 1, "2011": 2, "2012": 3}),
    ]
    ...
    def test_recording_of_EIA_data_tech(self):
        for n in range(0, len(self.EIA_nrg_stock_filter)):
            (a, b) = rm.nrg_stock_select(self.EIA_nrg_stock, self.EIA_nrg_stock_filter[n])
    ...
    def test_recording_of_EIA_data_sqft_homes(self):
        for n in range(0, len(self.EIA_sqft_homes_filter)):
            a = rm.sqft_homes_select(self.EIA_nrg_stock, self.EIA_sqft_homes_filter[n])
    ...
    def test_recording_of_thermal_loads_data(self):
        self.assertEqual(
            rm.thermal_load_select(self.tloads_example, self.tl_flt), self.tloads_sample
        )
...
class DataToListFormatTest(unittest.TestCase):
    ...
    loads_data = [
        ("CL", 2, 3, 100, -0.25, 0.25, 0, 0, 0.25, 0, 0.5, 0),
    ...
    ok_filters = [
        ...
        ["new england", "single family home", "electricity", "TVs", "set top box"],
        ["new england", "multi family home", "electricity", "TVs", "set top box"],
        ["mid atlantic", "multi family home", "electricity", "other", "electric other"],
        ["new england", "single family home", "electricity", "heating", "demand", "ground"],
        [
            "mid atlantic",
            "single family home",
            "natural gas",
        ...
        ["mid atlantic", "mobile home", "natural gas", "cooling", "demand", "windows solar"],
        ["new england", "single family home", "total square footage"],
        [
            "east north central",
            "single family home",
        ...
        ["new england", "single family home", "electricity", "lighting", "general service (LED)"],
        ["new england", "single family home", "new homes"],
        ["new england", "single family home", "total homes"],
    ...
    nonsense_filters = [
        ["mid atlantic", "mobile home", "natural gas", "heating", "room AC"],
        ["pacific", "single family home", "electricity (on site)", "water heating", "solar WH"],
        ["new england", "single family home", "distillate", "TVs", "set top box"],
    ]
    ...
    fail_filters = [
        ["the moon", "single family home", "electricity", "heating", "supply", "resistance heat"],
        ["new england", "single family cave", "natural gas", "secondary heating"],
        ["new england", "mobile home", "human locomotion", "lighting", "reflector"],
        [
            "south atlantic",
            "single family home",
            "distillate",
        ...
        ["mid atlantic", "mobile home", "electricity", "heating", "supply", "boiler (wood fired)"],
        [
            "east north central",
            "multi family home",
            "natural gas",
        ...
        ["pacific", "multi family home", "electricity", "other", "beer cooler"],
        ["pacific", "multi home", "total square footage"],
        ["pacific", "multi family home", "square foot"],
        ["mid atlantic", "mobile home", "renewables", "water heating", "solar WH"],
        [
            "east north central",
            "single family home",
            "other fuel",
        ...
        ["pacific", "multi family home", "total square footage", "natural gas", "water heating"],
        ["pacific", "multi family home", "new homes", "natural gas", "water heating"],
        ["pacific", "multi family home", "total homes", "natural gas", "water heating"],
    ]
    ...
    # information above
    ok_out = [
        [{"stock": {"2010": 0, "2011": 0}, "energy": {"2010": 1, "2011": 1}}, nrg_stock_array],
        [
            {"stock": {"2010": 10, "2011": 10}, "energy": {"2010": 11, "2011": 11}},
            np.hstack([nrg_stock_array[:10], nrg_stock_array[12:]]),
        ],
        [
            {"stock": {"2010": 12, "2011": 12}, "energy": {"2010": 13, "2011": 13}},
            np.hstack([nrg_stock_array[:12], nrg_stock_array[14:]]),
        ],
        [
            {"stock": {"2010": 18, "2011": 18}, "energy": {"2010": 19, "2011": 19}},
            np.hstack([nrg_stock_array[:16], nrg_stock_array[18:]]),
        ],
        [
            {"stock": {"2010": 22, "2011": 22}, "energy": {"2010": 23, "2011": 23}},
            np.hstack([nrg_stock_array[:20], nrg_stock_array[22:]]),
        ],
        [
            {"stock": {"2010": 24, "2011": 24}, "energy": {"2010": 25, "2011": 25}},
            np.hstack([nrg_stock_array[:22], nrg_stock_array[24:]]),
        ],
        [
            {"stock": {"2010": 36, "2011": 36}, "energy": {"2010": 37, "2011": 37}},
            np.hstack([nrg_stock_array[:24], nrg_stock_array[26:]]),
        ],
        [{"stock": "NA", "energy": {"2010": 0.3, "2011": 0.3}}, nrg_stock_array],
        [{"stock": "NA", "energy": {"2010": -6.0, "2011": -6.0}}, nrg_stock_array],
        [{"stock": "NA", "energy": {"2010": 1.75, "2011": 1.75}}, nrg_stock_array],
        [{"2010": 101, "2011": 101}, np.hstack([nrg_stock_array[0:26], nrg_stock_array[28:]])],
        [
            {"stock": {"2010": 20, "2011": 20}, "energy": {"2010": 21, "2011": 21}},
        ...
        [{"2010": 299, "2011": 299}, np.hstack([nrg_stock_array[0:-4], nrg_stock_array[-2:]])],
        [{"2010": 3, "2011": 4}, nrg_stock_array],
        [
            {"stock": {"2010": 35, "2011": 355}, "energy": {"2010": 757, "2011": 787}},
            nrg_stock_array[:-2],
        ],
        [
            {
...
class LightingEfficiencyTablePrepTest(unittest.TestCase):
    ...
    def test_lighting_efficiency_table_prep(self):
        result = rm.lighting_eff_prep(
            self.lighting_cpl_data, self.total_n_years, self.n_lighting_types
        )
        ...
        for row in self.lighting_eff_result:
            ...
            fn_result_row = result[
                np.all(
                    [
                        result["Application"] == row["Application"],
                        result["BulbType"] == row["BulbType"],
                    ],
                    axis=0,
                )
            ]
...
class LightingStockWeightedFactorsTest(unittest.TestCase):
    ...
    nrg_stock_array = np.array(
        [
            ("LT", 1, 1, "EL", "GSL", 2011, 164420.0, 1452680, 0, "INC"),
            ("LT", 1, 1, "EL", "GSL", 2012, 159428.0, 1577350, 0, "INC"),
            ("LT", 1, 1, "EL", "GSL", 2013, 153895.0, 1324963, 0, "INC"),
            ("LT", 1, 2, "EL", "GSL", 2011, 92810.0, 1452680, 0, "INC"),
            ("LT", 1, 2, "EL", "GSL", 2012, 87534.0, 1577350, 0, "INC"),
            ("LT", 1, 2, "EL", "GSL", 2013, 83958.0, 1324963, 0, "INC"),
            ("LT", 3, 1, "EL", "GSL", 2011, 103295.0, 1452680, 0, "INC"),
            ("LT", 3, 1, "EL", "GSL", 2012, 95567.0, 1577350, 0, "INC"),
            ("LT", 3, 1, "EL", "GSL", 2013, 89356.0, 1324963, 0, "INC"),
            ("LT", 3, 2, "EL", "GSL", 2011, 177692.0, 1452680, 0, "INC"),
            ("LT", 3, 2, "EL", "GSL", 2012, 175438.0, 1577350, 0, "INC"),
            ("LT", 3, 2, "EL", "GSL", 2013, 172984.0, 1324963, 0, "INC"),
            ("LT", 1, 1, "EL", "GSL", 2011, 76592.0, 1452680, 0, "LED"),
            ("LT", 1, 1, "EL", "GSL", 2012, 82953.0, 1577350, 0, "LED"),
            ("LT", 1, 1, "EL", "GSL", 2013, 90485.0, 1324963, 0, "LED"),
            ("LT", 1, 2, "EL", "GSL", 2011, 98475.0, 1452680, 0, "LED"),
            ("LT", 1, 2, "EL", "GSL", 2012, 101374.0, 1577350, 0, "LED"),
            ("LT", 1, 2, "EL", "GSL", 2013, 104884.0, 1324963, 0, "LED"),
            ("LT", 3, 1, "EL", "GSL", 2011, 73968.0, 1452680, 0, "LED"),
            ("LT", 3, 1, "EL", "GSL", 2012, 76948.0, 1577350, 0, "LED"),
            ("LT", 3, 1, "EL", "GSL", 2013, 81524.0, 1324963, 0, "LED"),
            ("LT", 3, 2, "EL", "GSL", 2011, 123744.0, 1452680, 0, "LED"),
            ("LT", 3, 2, "EL", "GSL", 2012, 127777.0, 1577350, 0, "LED"),
            ("LT", 3, 2, "EL", "GSL", 2013, 134395.0, 1324963, 0, "LED"),
            ("LT", 1, 1, "EL", "LFL", 2011, 172698.0, 1452680, 0, "T12"),
            ("LT", 1, 1, "EL", "LFL", 2012, 171593.0, 1577350, 0, "T12"),
            ("LT", 1, 1, "EL", "LFL", 2013, 169985.0, 1324963, 0, "T12"),
            ("LT", 1, 2, "EL", "LFL", 2011, 92416.0, 1452680, 0, "T12"),
            ("LT", 1, 2, "EL", "LFL", 2012, 90115.0, 1577350, 0, "T12"),
            ("LT", 1, 2, "EL", "LFL", 2013, 87888.0, 1324963, 0, "T12"),
            ("LT", 3, 1, "EL", "LFL", 2011, 185455.0, 1452680, 0, "T12"),
            ("LT", 3, 1, "EL", "LFL", 2012, 181322.0, 1577350, 0, "T12"),
            ("LT", 3, 1, "EL", "LFL", 2013, 176931.0, 1324963, 0, "T12"),
            ("LT", 3, 2, "EL", "LFL", 2011, 76209.0, 1452680, 0, "T12"),
            ("LT", 3, 2, "EL", "LFL", 2012, 75481.0, 1577350, 0, "T12"),
            ("LT", 3, 2, "EL", "LFL", 2013, 73852.0, 1324963, 0, "T12"),
            ("LT", 1, 1, "EL", "LFL", 2011, 191584.0, 1452680, 0, "T-8"),
            ("LT", 1, 1, "EL", "LFL", 2012, 192987.0, 1577350, 0, "T-8"),
            ("LT", 1, 1, "EL", "LFL", 2013, 194125.0, 1324963, 0, "T-8"),
            ("LT", 1, 2, "EL", "LFL", 2011, 173111.0, 1452680, 0, "T-8"),
            ("LT", 1, 2, "EL", "LFL", 2012, 174952.0, 1577350, 0, "T-8"),
            ("LT", 1, 2, "EL", "LFL", 2013, 176339.0, 1324963, 0, "T-8"),
            ("LT", 3, 1, "EL", "LFL", 2011, 175865.0, 1452680, 0, "T-8"),
            ("LT", 3, 1, "EL", "LFL", 2012, 176488.0, 1577350, 0, "T-8"),
            ("LT", 3, 1, "EL", "LFL", 2013, 177539.0, 1324963, 0, "T-8"),
            ("LT", 3, 2, "EL", "LFL", 2011, 90090.0, 1452680, 0, "T-8"),
            ("LT", 3, 2, "EL", "LFL", 2012, 94938.0, 1577350, 0, "T-8"),
            ("LT", 3, 2, "EL", "LFL", 2013, 100068.0, 1324963, 0, "T-8"),
            ("LT", 1, 1, "EL", "LFL", 2011, 132882.0, 1452680, 0, "T-5"),
            ("LT", 1, 1, "EL", "LFL", 2012, 134854.0, 1577350, 0, "T-5"),
            ("LT", 1, 1, "EL", "LFL", 2013, 135321.0, 1324963, 0, "T-5"),
            ("LT", 1, 2, "EL", "LFL", 2011, 125079.0, 1452680, 0, "T-5"),
            ("LT", 1, 2, "EL", "LFL", 2012, 126162.0, 1577350, 0, "T-5"),
            ("LT", 1, 2, "EL", "LFL", 2013, 127754.0, 1324963, 0, "T-5"),
            ("LT", 3, 1, "EL", "LFL", 2011, 139793.0, 1452680, 0, "T-5"),
            ("LT", 3, 1, "EL", "LFL", 2012, 142444.0, 1577350, 0, "T-5"),
            ("LT", 3, 1, "EL", "LFL", 2013, 144879.0, 1324963, 0, "T-5"),
            ("LT", 3, 2, "EL", "LFL", 2011, 135412.0, 1452680, 0, "T-5"),
            ("LT", 3, 2, "EL", "LFL", 2012, 137854.0, 1577350, 0, "T-5"),
            ("LT", 3, 2, "EL", "LFL", 2013, 140276.0, 1324963, 0, "T-5"),
    ...
    def test_lighting_weighting_factors_function(self):
        result = rm.calc_lighting_factors(
            self.nrg_stock_array,
        ...
        for expect_row in self.lt_factor_expected:
            ...
            np.testing.assert_allclose(expect_row["FACTOR"], result_row["FACTOR"])
...
class LightingDictModificationFunctionTest(unittest.TestCase):
    ...
    def test_difference_without_modification(self):
        self.assertFalse(rm.technology_supplydict == self.comparison_tech_dict)
    ...
    def test_modification_of_global_dict(self):
        ...
        self.assertDictEqual(rm.technology_supplydict, self.comparison_tech_dict)
