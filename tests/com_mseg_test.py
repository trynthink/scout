...
@unittest.skipUnless(
    "EXPECT_EIA_FILES" in os.environ and os.environ["EXPECT_EIA_FILES"] == "true",
...
class EIADataFileIntegrityTest(unittest.TestCase):
    ...
    def test_integrity_of_main_commercial_database(self):
        ...
        col_heads = ["Division", "BldgType", "EndUse", "Fuel", "Year", "Amount", "Label"]

        # Test for the presence of all of the anticipated column headings
        for head in col_heads:
            self.assertTrue(head in self.db_head, msg=head + " column not found.")
    ...
    def test_integrity_of_commercial_service_demand_database(self):
        ...
        for head in col_heads:
            self.assertTrue(
                head in self.sd_head,
                msg="Column " + head + (" is missing from the service demand data file."),
            )
...
class CommonUnitTest(unittest.TestCase):
    ...
    sample_keys = [
        ...
        ["east north central", "large office", "electricity", "office equipment"],
    ...
    sample_sd_array = np.array(
        [
            (2, 1, 2, 1, 1, 6, 1, 0.0, 0.0, 0.0, "rooftop_ASHP-cool 2003 installed base", 2.73),
            (2, 1, 2, 1, 2, 6, 1, 0.0, 0.0, 0.0, "rooftop_ASHP-cool 2003 installed base", 2.73),
            (
                2,
                1,
                2,
                ...
                0.012,
                0.011,
                "rooftop_ASHP-cool 2003 installed base",
                2.73,
            ),
            (2, 1, 2, 1, 1, 6, 2, 0.0, 0.0, 0.0, "rooftop_ASHP-cool 2012 installed base", 2.99),
            (2, 1, 2, 1, 2, 6, 2, 0.0, 0.0, 0.0, "rooftop_ASHP-cool 2012 installed base", 2.99),
            (2, 1, 2, 1, 3, 6, 2, 0.0, 0.0, 0.0, "rooftop_ASHP-cool 2012 installed base", 2.99),
            (
                2,
                1,
                2,
                ...
                0.0,
                0.0,
                "rooftop_ASHP-cool 2013 current standard/ typ",
                3.22,
            ),
            (
                2,
            ...
            (2, 1, 2, 1, 1, 6, 4, 0.001, 0.0, 0.0, "rooftop_ASHP-cool 2013 ENERGY STAR", 3.31),
            (2, 1, 2, 1, 2, 6, 4, 0.007, 0.0, 0.0, "rooftop_ASHP-cool 2013 ENERGY STAR", 3.31),
            (2, 1, 2, 1, 3, 6, 4, 0.067, 0.069, 0.064, "rooftop_ASHP-cool 2013 ENERGY STAR", 3.31),
            (2, 1, 2, 1, 1, 6, 5, 0.0, 0.0, 0.0, "rooftop_ASHP-cool 2013 high", 3.52),
            (2, 1, 2, 1, 2, 6, 5, 0.0, 0.0, 0.0, "rooftop_ASHP-cool 2013 high", 3.52),
            (2, 1, 2, 1, 3, 6, 5, 0.0, 0.0, 0.0, "rooftop_ASHP-cool 2013 high", 3.52),
            (2, 1, 2, 1, 1, 6, 6, 0.0, 0.001, 0.001, "rooftop_ASHP-cool 2020 typical", 3.22),
            (2, 1, 2, 1, 2, 6, 6, 0.0, 0.007, 0.007, "rooftop_ASHP-cool 2020 typical", 3.22),
            (2, 1, 2, 1, 3, 6, 6, 0.0, 0.0, 0.007, "rooftop_ASHP-cool 2020 typical", 3.22),
            (2, 1, 2, 1, 1, 6, 7, 0.0, 0.0, 0.0, "rooftop_ASHP-cool 2020 high", 3.52),
            (2, 1, 2, 1, 2, 6, 7, 0.0, 0.0, 0.0, "rooftop_ASHP-cool 2020 high", 3.52),
            (2, 1, 2, 1, 3, 6, 7, 0.0, 0.0, 0.0, "rooftop_ASHP-cool 2020 high", 3.52),
            (2, 1, 2, 1, 1, 7, 1, 0.0, 0.0, 0.0, "comm_GSHP-cool 2003 installed base", 4.04),
            (2, 1, 2, 1, 2, 7, 1, 0.0, 0.0, 0.0, "comm_GSHP-cool 2003 installed base", 4.04),
            (2, 1, 2, 1, 3, 7, 1, 0.009, 0.009, 0.008, "comm_GSHP-cool 2003 installed base", 4.04),
            (2, 1, 2, 1, 1, 7, 2, 0.0, 0.0, 0.0, "comm_GSHP-cool 2012 installed base", 4.1),
            (2, 1, 2, 1, 2, 7, 2, 0.0, 0.0, 0.0, "comm_GSHP-cool 2012 installed base", 4.1),
            (2, 1, 2, 1, 3, 7, 2, 0.0, 0.0, 0.0, "comm_GSHP-cool 2012 installed base", 4.1),
            (2, 1, 2, 1, 1, 7, 3, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 typical", 5.01),
            (2, 1, 2, 1, 2, 7, 3, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 typical", 5.01),
            (2, 1, 2, 1, 3, 7, 3, 0.002, 0.002, 0.002, "comm_GSHP-cool 2013 typical", 5.01),
            (2, 1, 2, 1, 1, 7, 4, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 mid", 5.16),
            (2, 1, 2, 1, 2, 7, 4, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 mid", 5.16),
            (2, 1, 2, 1, 3, 7, 4, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 mid", 5.16),
            (2, 1, 2, 1, 1, 7, 5, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 high", 6.04),
            (2, 1, 2, 1, 2, 7, 5, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 high", 6.04),
            (2, 1, 2, 1, 3, 7, 5, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 high", 6.04),
            (2, 1, 2, 1, 1, 7, 6, 0.0, 0.0, 0.0, "comm_GSHP-cool 2020 typical", 5.28),
            (2, 1, 2, 1, 2, 7, 6, 0.0, 0.0, 0.0, "comm_GSHP-cool 2020 typical", 5.28),
            (2, 1, 2, 1, 3, 7, 6, 0.0, 0.0, 0.0, "comm_GSHP-cool 2020 typical", 5.28),
            (2, 1, 2, 1, 1, 7, 7, 0.0, 0.0, 0.0, "comm_GSHP-cool 2020 high", 6.45),
            (2, 1, 2, 1, 2, 7, 7, 0.0, 0.0, 0.0, "comm_GSHP-cool 2020 high", 6.45),
            (2, 1, 2, 1, 3, 7, 7, 0.0, 0.0, 0.0, "comm_GSHP-cool 2020 high", 6.45),
            (2, 1, 2, 1, 1, 7, 8, 0.0, 0.0, 0.0, "comm_GSHP-cool 2030 typical", 5.86),
            (2, 1, 2, 1, 2, 7, 8, 0.0, 0.0, 0.0, "comm_GSHP-cool 2030 typical", 5.86),
            (2, 1, 2, 1, 3, 7, 8, 0.0, 0.0, 0.0, "comm_GSHP-cool 2030 typical", 5.86),
            (2, 1, 2, 1, 1, 7, 9, 0.0, 0.0, 0.0, "comm_GSHP-cool 2030 high", 7.03),
            (2, 1, 2, 1, 2, 7, 9, 0.0, 0.0, 0.0, "comm_GSHP-cool 2030 high", 7.03),
            (2, 1, 2, 1, 3, 7, 9, 0.0, 0.0, 0.0, "comm_GSHP-cool 2030 high", 7.03),
            (2, 1, 2, 1, 1, 7, 10, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 typ 10% ITC w MACRS", 5.01),
            (2, 1, 2, 1, 2, 7, 10, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 typ 10% ITC w MACRS", 5.01),
            (
                2,
                1,
                2,
                ...
                0.002,
                0.002,
                "comm_GSHP-cool 2013 typ 10% ITC w MACRS",
                5.01,
            ),
            (2, 1, 2, 1, 1, 7, 11, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 mid 10% ITC w MACRS", 5.16),
            (2, 1, 2, 1, 2, 7, 11, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 mid 10% ITC w MACRS", 5.16),
            (2, 1, 2, 1, 3, 7, 11, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 mid 10% ITC w MACRS", 5.16),
            (2, 1, 2, 1, 1, 7, 12, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 high 10% ITC w MACRS", 6.04),
            (2, 1, 2, 1, 2, 7, 12, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 high 10% ITC w MACRS", 6.04),
            (2, 1, 2, 1, 3, 7, 12, 0.0, 0.0, 0.0, "comm_GSHP-cool 2013 high 10% ITC w MACRS", 6.04),
            (2, 1, 2, 1, 1, 54, 1, 0.0, 0.0, 0.0, "res_type_central_AC 2003 installed base", 3.34),
            (2, 1, 2, 1, 2, 54, 1, 0.0, 0.0, 0.0, "res_type_central_AC 2003 installed base", 3.34),
            (
                2,
                1,
                2,
                ...
                0.595,
                0.549,
                "res_type_central_AC 2003 installed base",
                3.34,
            ),
            (
                2,
                ...
                0.004,
                0.004,
                "res_type_central_AC 2013 current standard",
                3.81,
            ),
            (
                2,
            ...
            (2, 1, 2, 1, 1, 54, 3, 0.0, 0.0, 0.0, "res_type_central_AC 2013 typical", 3.81),
            (2, 1, 2, 1, 2, 54, 3, 0.0, 0.0, 0.0, "res_type_central_AC 2013 typical", 3.81),
            (2, 1, 2, 1, 3, 54, 3, 0.0, 0.0, 0.0, "res_type_central_AC 2013 typical", 3.81),
            (2, 1, 2, 1, 1, 54, 4, 0.0, 0.0, 0.0, "res_type_central_AC 2013 ENERGY STAR", 4.25),
            (2, 1, 2, 1, 2, 54, 4, 0.0, 0.0, 0.0, "res_type_central_AC 2013 ENERGY STAR", 4.25),
            (
                2,
                1,
                2,
                ...
                0.012,
                0.012,
                "res_type_central_AC 2013 ENERGY STAR",
                4.25,
            ),
            (2, 1, 2, 1, 1, 54, 5, 0.0, 0.0, 0.0, "res_type_central_AC 2013 high", 7.03),
            (2, 1, 2, 1, 2, 54, 5, 0.0, 0.0, 0.0, "res_type_central_AC 2013 high", 7.03),
            (2, 1, 2, 1, 3, 54, 5, 0.0, 0.0, 0.0, "res_type_central_AC 2013 high", 7.03),
            (2, 1, 2, 1, 1, 54, 6, 0.0, 0.0, 0.0, "res_type_central_AC 2020 typical", 4.1),
            (2, 1, 2, 1, 2, 54, 6, 0.011, 0.011, 0.011, "res_type_central_AC 2020 typical", 4.1),
            (2, 1, 2, 1, 3, 54, 6, 0.105, 0.108, 0.11, "res_type_central_AC 2020 typical", 4.1),
            (2, 1, 2, 1, 1, 54, 7, 0.0, 0.0, 0.0, "res_type_central_AC 2020 high", 7.03),
            (2, 1, 2, 1, 2, 54, 7, 0.0, 0.0, 0.0, "res_type_central_AC 2020 high", 7.03),
            (2, 1, 2, 1, 3, 54, 7, 0.0, 0.0, 0.0, "res_type_central_AC 2020 high", 7.03),
            (2, 1, 2, 1, 1, 54, 8, 0.0, 0.0, 0.0, "res_type_central_AC 2030 typical", 4.1),
            (2, 1, 2, 1, 2, 54, 8, 0.0, 0.0, 0.0, "res_type_central_AC 2030 typical", 4.1),
            (2, 1, 2, 1, 3, 54, 8, 0.0, 0.0, 0.0, "res_type_central_AC 2030 typical", 4.1),
            (
                2,
                1,
                2,
                ...
                0.0,
                0.0,
                "res_type_gasHP-cool placeholder to reconcile",
                0.01,
            ),
            (
                2,
            ...
            (8, 2, 3, 2, 1, 22, 1, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2003 installed base", 0.76),
            (8, 2, 3, 2, 2, 22, 1, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2003 installed base", 0.76),
            (8, 2, 3, 2, 3, 22, 1, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2003 installed base", 0.76),
            (8, 2, 3, 2, 1, 22, 2, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2012 installed base", 0.78),
            (8, 2, 3, 2, 2, 22, 2, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2012 installed base", 0.78),
            (8, 2, 3, 2, 3, 22, 2, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2012 installed base", 0.78),
            (
                8,
                2,
                3,
                ...
                0.0,
                0.0,
                "gas_instantaneous_WH 2013 current standard",
                0.8,
            ),
            (
                8,
            ...
            (8, 2, 3, 2, 1, 22, 4, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2013 typical", 0.89),
            (8, 2, 3, 2, 2, 22, 4, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2013 typical", 0.89),
            (8, 2, 3, 2, 3, 22, 4, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2013 typical", 0.89),
            (8, 2, 3, 2, 1, 22, 5, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2013 high", 0.97),
            (8, 2, 3, 2, 2, 22, 5, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2013 high", 0.97),
            (8, 2, 3, 2, 3, 22, 5, 0.0, 0.0, 0.0, "gas_instantaneous_WH 2013 high", 0.97),
            (8, 2, 3, 2, 1, 57, 1, 0.0, 0.0, 0.0, "gas_water_heater  2003 installed base", 0.77),
            (8, 2, 3, 2, 2, 57, 1, 0.0, 0.0, 0.0, "gas_water_heater  2003 installed base", 0.77),
            (
                8,
                2,
                3,
                ...
                0.57,
                0.521,
                "gas_water_heater  2003 installed base",
                0.77,
            ),
            (
                8,
                ...
                0.037,
                0.035,
                "gas_water_heater  2013 current standard/ typ",
                0.8,
            ),
            (
                8,
            ...
            (8, 2, 3, 2, 1, 57, 3, 0.036, 0.035, 0.034, "gas_water_heater  2013 high", 0.99),
            (8, 2, 3, 2, 2, 57, 3, 0.144, 0.146, 0.147, "gas_water_heater  2013 high", 0.99),
            (8, 2, 3, 2, 3, 57, 3, 0.806, 0.905, 0.995, "gas_water_heater  2013 high", 0.99),
            (8, 2, 3, 2, 1, 57, 4, 0.0, 0.0, 0.0, "gas_water_heater  2020 typical", 0.8),
            (8, 2, 3, 2, 2, 57, 4, 0.0, 0.0, 0.0, "gas_water_heater  2020 typical", 0.8),
            (8, 2, 3, 2, 3, 57, 4, 0.0, 0.0, 0.0, "gas_water_heater  2020 typical", 0.8),
            (8, 2, 3, 2, 1, 57, 5, 0.0, 0.0, 0.0, "gas_water_heater  2020 high", 0.99),
            (8, 2, 3, 2, 2, 57, 5, 0.0, 0.0, 0.0, "gas_water_heater  2020 high", 0.99),
            (8, 2, 3, 2, 3, 57, 5, 0.0, 0.0, 0.0, "gas_water_heater  2020 high", 0.99),
            (4, 7, 6, 1, 1, 24, 15, 0, 0, 0, "90W Halogen PAR-38 2003 installed base", 13.5),
            (4, 7, 6, 1, 2, 24, 15, 0, 0, 0, "90W Halogen PAR-38 2003 installed base", 13.5),
            (
                4,
                7,
                6,
            ...
            (4, 7, 6, 1, 1, 24, 16, 0, 0, 0, "90W Halogen PAR-38 2007 installed base", 13.5),
            (4, 7, 6, 1, 2, 24, 16, 0, 0, 0, "90W Halogen PAR-38 2007 installed base", 13.5),
            (
                4,
                7,
                6,
            ...
            (4, 7, 6, 1, 1, 24, 17, 0, 0, 0, "90W Halogen PAR-38 2011 typical", 13.7),
            (4, 7, 6, 1, 2, 24, 17, 0, 0, 0, "90W Halogen PAR-38 2011 typical", 13.7),
            (4, 7, 6, 1, 3, 24, 17, 0, 0, 0, "90W Halogen PAR-38 2011 typical", 13.7),
            (4, 7, 6, 1, 1, 24, 18, 0, 0, 0, "90W Halogen PAR-38 2020 typical", 14.34),
            (4, 7, 6, 1, 2, 24, 18, 0, 0, 0, "90W Halogen PAR-38 2020 typical", 14.34),
            (4, 7, 6, 1, 3, 24, 18, 0, 0, 0, "90W Halogen PAR-38 2020 typical", 14.34),
            (4, 7, 6, 1, 1, 24, 19, 0, 0, 0, "90W Halogen PAR-38 2030 typical", 15.06),
            (4, 7, 6, 1, 2, 24, 19, 0, 0, 0, "90W Halogen PAR-38 2030 typical", 15.06),
            (4, 7, 6, 1, 3, 24, 19, 0, 0, 0, "90W Halogen PAR-38 2030 typical", 15.06),
            (4, 7, 6, 1, 1, 25, 2, 0, 0, 0, "T8 2e),", 59),
            (4, 7, 6, 1, 2, 25, 2, 0, 0, 0, "T8 2e),", 59),
            (4, 7, 6, 1, 3, 25, 2, 0.039, 0.036, 0.034, "T8 2e),", 59),
            (4, 7, 6, 1, 1, 25, 15, 0.088, 0, 0, "F28T8 HE w/ OS &amp; SR 2011 typical", 178.7),
            (4, 7, 6, 1, 2, 25, 15, 0.262, 0, 0, "F28T8 HE w/ OS &amp; SR 2011 typical", 178.7),
            (
                4,
                7,
                6,
            ...
            (4, 7, 6, 1, 1, 25, 17, 0, 0, 0, "F28T8 HE w/ OS &amp; SR 2030 typical", 195.29),
            (4, 7, 6, 1, 2, 25, 17, 0, 0, 0, "F28T8 HE w/ OS &amp; SR 2030 typical", 195.29),
            (4, 7, 6, 1, 3, 25, 17, 0, 0, 0, "F28T8 HE w/ OS &amp; SR 2030 typical", 195.29),
            (4, 7, 6, 1, 1, 27, 2, 0, 0, 0, "MH 175_LB 2003 installed base", 31.8),
            (4, 7, 6, 1, 2, 27, 2, 0, 0, 0, "MH 175_LB 2003 installed base", 31.8),
            (4, 7, 6, 1, 3, 27, 2, 0.018, 0.016, 0.014, "MH 175_LB 2003 installed base", 31.8),
            (4, 7, 6, 1, 1, 27, 3, 0, 0, 0, "MH 175_LB 2007 installed base", 34.01),
            (4, 7, 6, 1, 2, 27, 3, 0, 0, 0, "MH 175_LB 2007 installed base", 34.01),
            (4, 7, 6, 1, 3, 27, 3, 0, 0, 0, "MH 175_LB 2007 installed base", 34.01),
            (4, 7, 6, 1, 1, 27, 4, 0, 0, 0, "MH 175_LB 2011 typical", 51.22),
            (4, 7, 6, 1, 2, 27, 4, 0, 0, 0, "MH 175_LB 2011 typical", 51.22),
            (4, 7, 6, 1, 3, 27, 4, 0, 0, 0, "MH 175_LB 2011 typical", 51.22),
            (4, 7, 6, 1, 1, 27, 5, 0, 0, 0, "MH 175_LB 2020 typical/ 2017 standard", 52.76),
            (4, 7, 6, 1, 2, 27, 5, 0, 0, 0, "MH 175_LB 2020 typical/ 2017 standard", 52.76),
            (4, 7, 6, 1, 3, 27, 5, 0, 0, 0, "MH 175_LB 2020 typical/ 2017 standard", 52.76),
            (4, 7, 6, 1, 1, 27, 6, 0, 0, 0, "MH 175_LB 2030 typical", 54.47),
            (4, 7, 6, 1, 2, 27, 6, 0, 0, 0, "MH 175_LB 2030 typical", 54.47),
            (4, 7, 6, 1, 3, 27, 6, 0, 0, 0, "MH 175_LB 2030 typical", 54.47),
            (4, 7, 6, 1, 1, 27, 11, 0, 0, 0, "2L F54T5HO LB", 67.8),
            (4, 7, 6, 1, 2, 27, 11, 0, 0, 0, "2L F54T5HO LB", 67.8),
            (4, 7, 6, 1, 3, 27, 11, 0, 0, 0, "2L F54T5HO LB", 67.8),
            (
                1,
                1,
                7,
                ...
                0.000,
                0.000,
                "Commercial Refrigerated Vending Machines 201",
                2.85,
            ),
            (
                1,
            ...
            (
                ...
                0.000,
                0.000,
                "Commercial Refrigerated Vending Machines 202",
                3.42,
            ),
            (
                1,
            ...
            (
                ...
                0.000,
                0.000,
                "Commercial Refrigerated Vending Machines 203",
                3.52,
            ),
            (
                1,
            ...
            (
                ...
                0.000,
                0.000,
                "Commercial Refrigerated Vending Machines 204",
                3.59,
            ),
            (
                1,
    ...
    # or exception
    fail_keys = [
        ["new england", "mobile home", "electricity", "cooling", "demand", "people gain"],
        ["west south central", "single family home", "natural gas", "water heating"],
        ["west north central", "cooking", "natural gas", "drying"],
        ["pacific", "large office", "security systems", "distillate"],
        ["neptune", "education", "distillate", "heating", "supply"],
        ["mountain", "small office", "lamp oil", "lighting"],
    ]

    # Define lists that specify the census division, building type,
    # end use, and fuel type from which to select the desired data
    selections = [[2, 1, 2, 1], [8, 2, 3, 2], [4, 7, 6, 1], [1, 1, 7, 1]]

    technames = [
        ["comm_GSHP-cool", "res_type_central_AC", "rooftop_ASHP-cool"],
        ["gas_instantaneous_WH", "gas_water_heater"],
        ["2L F54T5HO LB", "90W Halogen PAR-38", "F28T8 HE w/ OS &amp; SR", "MH 175_LB", "T8 2e),"],
    ...
    sd_percentages = [
        np.array(
            [
                [0.00650618, 0.00623814, 0.0058495],
    ...
    MEL_status = [False, False, True, True, False, False, False, False, False, False, False]

    # Define list of expected numpy structured arrays generated by
    # the function to be tested
    expected_selection = [
        np.array(
            [("2019", 1.503), ("2020", 1.499), ("2021", 1.493)],
            dtype=[("Year", "U4"), ("Amount", "f8")],
        ),
        np.array(
            [("2019", 0.083), ("2020", 0.081), ("2021", 0.078)],
            dtype=[("Year", "U4"), ("Amount", "f8")],
        ),
        np.array(
        ...
        np.array(
            [("2019", 2.430), ("2020", 2.399), ("2021", 2.360)],
            dtype=[("Year", "U4"), ("Amount", "f8")],
        ),
        np.array(
            [("2019", 9.430), ("2020", 9.373), ("2021", 9.311)],
            dtype=[("Year", "U4"), ("Amount", "f8")],
        ),
        np.array(
            [("2019", 3.641), ("2020", 3.647), ("2021", 3.654)],
            dtype=[("Year", "U4"), ("Amount", "f8")],
        ),
        np.array(
        ...
        np.array(
            [("2019", 2484.2), ("2020", 2515.2), ("2021", 2542.1)],
            dtype=[("Year", "U4"), ("Amount", "f8")],
        ),
    ]
    ...
    dict_list = [
        {"energy": {"2019": 1652398.2, "2020": 1648000.6, "2021": 1641404.2}, "stock": "NA"},
        {"energy": {"2019": 6972, "2020": 6804, "2021": 6552}, "stock": "NA"},
        {"energy": {"2019": 101000, "2020": 103000, "2021": 106000}, "stock": "NA"},
        {"energy": {"2019": 1475000, "2020": 1484000, "2021": 1492000}, "stock": "NA"},
        {
            "rooftop_ASHP-cool": {
                "energy": {"2019": 134394.24, "2020": 137115.18, "2021": 139225.79},
                "stock": {"2019": 0.088, "2020": 0.089, "2021": 0.09},
            },
            "comm_GSHP-cool": {
                "energy": {"2019": 15810.03, "2020": 14965.3, "2021": 13804.82},
                "stock": {"2019": 0.014, "2020": 0.013, "2021": 0.013},
            },
            "res_type_central_AC": {
                "energy": {"2019": 2279795.73, "2020": 2246919.53, "2021": 2206969.39},
                "stock": {"2019": 1.691, "2020": 1.657, "2021": 1.625},
            },
        },
        {
            "gas_instantaneous_WH": {
                "energy": {"2019": 0, "2020": 0, "2021": 0},
                "stock": {"2019": 0, "2020": 0, "2021": 0},
            },
            "gas_water_heater": {
                "energy": {"2019": 9430000, "2020": 9373000, "2021": 9311000},
                "stock": {"2019": 3.845, "2020": 3.889, "2021": 3.927},
            },
        },
        {
            "2L F54T5HO LB": {
                "energy": {"2019": 0.0, "2020": 0.0, "2021": 0.0},
                "stock": {"2019": 0, "2020": 0, "2021": 0},
            },
            "90W Halogen PAR-38": {
                "energy": {"2019": 1465260.60, "2020": 1416056.94, "2021": 1371510.1},
                "stock": {"2019": 0.124, "2020": 0.111, "2021": 0.1},
            },
            "F28T8 HE w/ OS &amp; SR": {
                "energy": {"2019": 1979994.32, "2020": 2039204.6, "2021": 2094276.79},
                "stock": {"2019": 2.218, "2020": 2.121, "2021": 2.031},
            },
            "MH 175_LB": {
                "energy": {"2019": 90296.8, "2020": 86653.15, "2021": 81514.28},
                "stock": {"2019": 0.018, "2020": 0.016, "2021": 0.014},
            },
            "T8 2e),": {
                "energy": {"2019": 105448.29, "2020": 105085.31, "2021": 106698.84},
                "stock": {"2019": 0.039, "2020": 0.036, "2021": 0.034},
            },
        },
        {"energy": {"2019": 11983000, "2020": 12165000, "2021": 12377000}, "stock": "NA"},
        {"energy": {"2019": 24763000, "2020": 24724000, "2021": 24733000}, "stock": "NA"},
        {"2019": 2.097, "2020": 2.074, "2021": 2.037},
...
class JSONInterpretationTest(CommonUnitTest):
    ...
    def test_expected_succesful_key_conversion(self):
        for idx, a_key_list in enumerate(self.sample_keys):
            self.assertEqual(cm.json_interpreter(a_key_list), self.sample_keys_converted[idx])
...
class PercentageCalculationTest(CommonUnitTest):
    ...
    def test_service_demand_percentage_conversion(self):
        self.assertTrue((np.round(self.a_pct - self.sd_percentages[0], decimals=5) == 0).all())
        self.assertTrue((np.round(self.c_pct - self.sd_percentages[1], decimals=5) == 0).all())
        self.assertTrue((np.round(self.e_pct - self.sd_percentages[2], decimals=5) == 0).all())
...
class CommercialDataSelectionTest(CommonUnitTest):
    ...
    def test_data_selection_and_reduction(self):
        for idx, the_keys in enumerate(self.sample_keys):
            ...
            np.testing.assert_array_equal(
                cm.catg_data_selector(
                    self.sample_db_array, select_indices, correct_label_str, self.years
                ),
...
class ServiceDemandFallbackTest(unittest.TestCase):
    ...
    def test_data_handler_uses_broader_sd_fallback(self):
        years = [2019, 2020]
        db_array = np.array(
            [(5, 6, 2, 2, 30, 10.0, "EndUseConsump"), (5, 6, 2, 2, 31, 20.0, "EndUseConsump")],
            dtype=[
                ("Division", "<i4"),
                ("BldgType", "<i4"),
                ("EndUse", "<i4"),
        ...
        sd_array = np.array(
            [
                (5, 4, 2, 2, 1, 1, 1, 6.0, 8.0, "gas_chiller 2019 installed base", 1.0),
                (5, 4, 2, 2, 1, 1, 2, 2.0, 2.0, "gas_eng-driven_RTAC 2019 installed base", 2.0),
            ],
            dtype=[
                ("r", "<i4"),
                ("b", "<i4"),
        ...
        load_array = np.array([], dtype=[("CDIV", "<i4"), ("BLDG", "<i4"), ("ENDUSE", "<U2")])
        ...
        self.assertCountEqual(result.keys(), ["gas_chiller", "gas_eng-driven_RTAC"])
    ...
    def test_data_handler_skips_zero_only_sd_scope(self):
        ...
        sd_array = np.array(
            [
                ...
                (5, 4, 2, 2, 1, 1, 1, 0.0, 0.0, "gas_chiller 2019 installed base", 1.0),
                (5, 4, 2, 2, 1, 1, 2, 0.0, 0.0, "gas_eng-driven_RTAC 2019 installed base", 2.0),
                # Different-region rows carry non-zero service demand.
                (4, 4, 2, 2, 1, 1, 1, 6.0, 8.0, "gas_chiller 2019 installed base", 1.0),
                (4, 4, 2, 2, 1, 1, 2, 2.0, 2.0, "gas_eng-driven_RTAC 2019 installed base", 2.0),
            ],
            dtype=[
                ("r", "<i4"),
                ("b", "<i4"),
            ...
            "large office": {
                "electricity": {
                    "MELs": {
                        ...
                        "water services": {"energy": {}, "stock": "NA"},
                        "telecom systems": {"energy": {}, "stock": "NA"},
                        "other": {
                            "energy": {
                                "2018": 17,
                                "2019": 23,
