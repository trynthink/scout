...
if __name__ == "__main__":
    ...
    skip_sheets = [
        "TOC",
        "Master_Mapping_Sheet",
        "Grid_Region_Mapping",
        "County_Data_CZones",
        "Pop_Census_2023",
        "EMM_State_Elec_Map_NEMS_SEDS",
        "State_Fossil_Mapping_SEDS",
        "Res_AllFuels_SEDS_2022_TBtus",
        "Com_AllFuels_SEDS_2022_TBtus",
        "State_EMM",
        "State_EMM_Rev",
        "State_EMM-EMF37",
        "EMM_National",
        "Res_SF_Homes_RECS_2020",
        "State_Fossil_All_Mapping_SEDS",
        "State_EMM_ColSums",
        "State_EMM_RowSums",
        "ASH_State_ColSums",
    ]
