...
class ECMPrepHelper:
    ...
    def update_run_setup(run_setup: dict,
                         ...
                         meas_toprep_indiv: list,
                         handyvars: UsefulVars) -> dict:
        ...
        # Exclude all contributing ECMs in a package unless user desires competition of
        # equipment-only ECM with package and the ECM is an equipment ECM
                ...
                if update_indiv_ecm or meas_in_pkgs:
                    ...
                    if add_ref_meas:
                        ...
                        if (
                            ...
                            and opts.exog_hp_rates is False
                        ):
