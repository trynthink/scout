...
class UsefulInputFiles(object):
    ...
    def __init__(self, opts):
        ...
        self.tsv_metrics_data_tot_ref_genpk = fp.TSV_DATA / "tsv_hrs_tot_ref_genpk.csv"
        self.tsv_metrics_data_net_ref_genpk = fp.TSV_DATA / "tsv_hrs_net_ref_genpk.csv"
        self.tsv_metrics_data_tot_hr_genpk = fp.TSV_DATA / "tsv_hrs_tot_hr_genpk.csv"
        self.tsv_metrics_data_net_hr_genpk = fp.TSV_DATA / "tsv_hrs_net_hr_genpk.csv"
