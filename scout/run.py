...
class Engine(object):
                            ...
                            for vint in conv_fracs[out][reg][bldg][fuel][eu].keys():
                                ...
                                for yr in conv_fracs[out][reg][bldg][fuel][eu][vint].keys():
                                    ...
                                    if conv_fracs[out][reg][bldg][fuel][eu][vint][yr]["all"] != 0:
                                        ...
                                        # Ensure the conversion fraction is never above 1, below 0
                                        if conv_fracs[out][reg][bldg][fuel][eu][vint][yr] > 1:
                                            conv_fracs[out][reg][bldg][fuel][eu][vint][yr] = 1
                                        elif conv_fracs[out][reg][bldg][fuel][eu][vint][yr] < 0:
            ...
            for var in ["stock", "energy", "carbon", "cost"]:
                ...
                if onsite_times_apply_fracs:
                    self.apply_onsite_reduce(
                        ...
                        meas_eus, res_focus, meas_gap_fracs, cdbps_gap_fracs)
    ...
    def apply_onsite_reduce(
            ...
            vint_in, meas_fuel, meas_eus, res_focus, meas_gap_fracs, cdbps_gap_fracs):
