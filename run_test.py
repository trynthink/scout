...
class FindPartitionMasterMicrosegmentTest(unittest.TestCase, CommonMethods):
    ...
    ok_out = [{"stock": {"total": {"2009": 72, "2010": 72},
                         ...
                         "competed (captured)": {"2009": 72, "2010": 72}},
              ...
              {"stock": {"total": {"2009": 148, "2010": 148},
                         ...
                         "competed (captured)": {"2009": 148, "2010": 148}},
              ...
              {"stock": {"total": {"2009": 1600, "2010": 2000},
                         ...
                         "competed (captured)": {"2009": 1600, "2010": 2000}},
              ...
              {"stock": {"total": {"2009": 600, "2010": 800},
                         ...
                         "competed (captured)": {"2009": 600, "2010": 800}},
              ...
              {"stock": {"total": {"2009": 11, "2010": 11},
                         ...
                         "competed (captured)": {"2009": 11, "2010": 11}},
              ...
              {"stock": {"total": {"2009": 1.5, "2010": 0.75},
                         ...
                         "competed (captured)": {"2009": 1.5, "2010": 0.75}},
              ...
              {"stock": {"total": {"2009": 13.5, "2010": 14.25},
                         ...
                         "competed (captured)": {"2009": 13.5, "2010": 14.25}},
    ...
    partial_out = [{"stock": {"total": {"2009": 18, "2010": 18},
                              ...
                              "competed (captured)": {"2009": 18, "2010": 18}},
                   ...
                   {"stock": {"total": {"2009": 52, "2010": 52},
                              ...
                              "competed (captured)": {"2009": 52, "2010": 52}},
...
class PrioritizationMetricsTest(unittest.TestCase, CommonMethods):
    ...
    ok_master_mseg_point = {
        "stock": {
            ...
            "competed (captured)": {"2009": 5, "2010": 10}},
        "energy": {
            ...
            "anpv": {
                "stock cost": {
                    ...
                    "2010": {
                        ...
                        "rate 6": numpy.pmt(0.065, 2, 0.9084507),
                        "rate 7": -0.5}},
                "energy cost": {
                    "2009": {
...
class ResCompeteTest(unittest.TestCase, CommonMethods):
    ...
    measures_master_msegs = [{
        "stock": {
            "total": {"2009": 10, "2010": 10},
            "competed": {"2009": 5, "2010": 5},
            "competed (captured)": {"2009": 1.11, "2010": 1.11}},
        "energy": {
            "total": {"2009": 20, "2010": 20},
            "competed": {"2009": 10, "2010": 10},
        ...
        "stock": {
            "total": {"2009": 20, "2010": 20},
            "competed": {"2009": 10, "2010": 10},
            "competed (captured)": {"2009": 7.77, "2010": 7.77}},
        "energy": {
            "total": {"2009": 40, "2010": 40},
            "competed": {"2009": 20, "2010": 20},
...
class ComCompeteTest(unittest.TestCase, CommonMethods):
    ...
    compete_meas1 = {
        ...
        "mseg_save": {
            "anpv": {
                "stock cost": {
                    "2009": {"rate 1": 85, "rate 2": 90, "rate 3": 95,
                             "rate 4": 100, "rate 5": 105, "rate 6": 110,
                             "rate 7": 115},
                    "2010": {"rate 1": 85, "rate 2": 90, "rate 3": 95,
                             "rate 4": 100, "rate 5": 105, "rate 6": 110,
                             "rate 7": 115}},
                "energy cost": {
                    "2009": {"rate 1": -435, "rate 2": -440, "rate 3": -145,
                             "rate 4": -150, "rate 5": -155, "rate 6": -160,
                             "rate 7": -370},
                    "2010": {"rate 1": -435, "rate 2": -440, "rate 3": -145,
                             "rate 4": -150, "rate 5": -155, "rate 6": -160,
                             "rate 7": -370}},
                "carbon cost": {
                    "2009": {"rate 1": -135, "rate 2": -140, "rate 3": -145,
                             "rate 4": -150, "rate 5": -155, "rate 6": -160,
                             "rate 7": -170},
                    "2010": {"rate 1": -135, "rate 2": -140, "rate 3": -145,
                             "rate 4": -150, "rate 5": -155, "rate 6": -160,
                             "rate 7": -170}}}}}
    ...
    compete_meas2 = {
        ...
        "mseg_save": {
            "anpv": {
                "stock cost": {
                    "2009": {"rate 1": 100, "rate 2": 110, "rate 3": 120,
                             "rate 4": 130, "rate 5": 140, "rate 6": 150,
                             "rate 7": 160},
                    "2010": {"rate 1": 100, "rate 2": 110, "rate 3": 120,
                             "rate 4": 130, "rate 5": 140, "rate 6": 150,
                             "rate 7": 160}},
                "energy cost": {
                    "2009": {"rate 1": -350, "rate 2": -60, "rate 3": -70,
                             "rate 4": -380, "rate 5": -390, "rate 6": -150,
                             "rate 7": -400},
                    "2010": {"rate 1": -350, "rate 2": -60, "rate 3": -70,
                             "rate 4": -380, "rate 5": -390, "rate 6": -150,
                             "rate 7": -400}},
                "carbon cost": {
                    "2009": {"rate 1": -40, "rate 2": -50, "rate 3": -55,
                             "rate 4": -60, "rate 5": -65, "rate 6": -70,
                             "rate 7": -75},
                    "2010": {"rate 1": -40, "rate 2": -50, "rate 3": -55,
                             "rate 4": -60, "rate 5": -65, "rate 6": -70,
                             "rate 7": -75}}}}}
    ...
    compete_meas3 = {
        ...
        "mseg_save": {
            "anpv": {
                "stock cost": {
                    "2009": {"rate 1": 50, "rate 2": 60, "rate 3": 70,
                             "rate 4": 80, "rate 5": 90, "rate 6": 100,
                             "rate 7": 110},
                    "2010": {"rate 1": 50, "rate 2": 60, "rate 3": 70,
                             "rate 4": 80, "rate 5": 90, "rate 6": 100,
                             "rate 7": 110}},
                "energy cost": {
                    "2009": {"rate 1": -190, "rate 2": -195, "rate 3": -190,
                             "rate 4": -205, "rate 5": -180, "rate 6": -230,
                             "rate 7": -200},
                    "2010": {"rate 1": -190, "rate 2": -195, "rate 3": -190,
                             "rate 4": -205, "rate 5": -180, "rate 6": -230,
                             "rate 7": -200}},
                "carbon cost": {
                    "2009": {"rate 1": -90, "rate 2": -95, "rate 3": -100,
                             "rate 4": -105, "rate 5": -110, "rate 6": -115,
                             "rate 7": -120},
                    "2009": {"rate 1": -90, "rate 2": -95, "rate 3": -100,
                             "rate 4": -105, "rate 5": -110, "rate 6": -115,
                             "rate 7": -120}}}}}
    ...
    measures_master_msegs = [{
        "stock": {
            "total": {"2009": 10, "2010": 10},
            "competed": {"2009": 5, "2010": 5},
            "competed (captured)": {"2009": 3, "2010": 3}},
        "energy": {
            "total": {"2009": 20, "2010": 20},
            "competed": {"2009": 10, "2010": 10},
        ...
        "stock": {
            "total": {"2009": 20, "2010": 20},
            "competed": {"2009": 10, "2010": 10},
            "competed (captured)": {"2009": 2, "2010": 2}},
        "energy": {
            "total": {"2009": 40, "2010": 40},
            "competed": {"2009": 20, "2010": 20},
