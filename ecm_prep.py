...
class Measure(object):
    ...
    def partition_microsegment(
        ...
        diffuse_frac_linked, comp_frac_diffuse_linked = (
            None for n in range(2))
        ...
        # primary mseg are flagged as being linked to those of another mseg
            ...
            # current mseg. If not, throw an error.
                ...
                if not initiate_linked_dat:
                    ...
                    # in cases where the total stock for the linked segment
                    # before adjustment via diffusion fraction is zero. When
                    # exogenous switching rates are used and the measure is
                    ...
                    raise ValueError(
                        "No data available to link mseg " + str(mskeys) +
        ...
        # cooling microsegments, set relevant adjustment variables to None
            ...
            secnd_mseg_adjkey, linked_htcl_tover_anchor_tech, \
                ...
                compete_htcl_lnk = (None for n in range(6))
