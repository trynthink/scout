...
if __name__ == "__main__":
    ...
    # Optional flag for alternate regional breakdown.
    parser.add_argument("--alt_regions_breakdown", type = int, default = 0,
                        help = "This option is ignored if --alt_regions is not specificed."
                        " 0 (default) for interactive specification of regional breakdonw."
