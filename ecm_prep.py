...
class UsefulInputFiles(object):
    ...
    Attributes:
        ...
        backup_fuel_data (tuple): Remaining existing fuel fraction data under
            dual fuel measure operation.
    """
    ...
    def __init__(self, opts):
        ...
        self.backup_fuel_data = (
            "ecm_definitions", "energyplus_data", "dual_fuel_ratios")
...
class UsefulVars(object):
    ...
    Attributes:
        ...
        htcl_anchor_tech_opts (dict): For measures that apply to seperate
                ...
                try:
                    self.backup_fuel_fraction = \
                        pd.read_csv(path.join(
                            base_dir, *handyfiles.backup_fuel_data,
